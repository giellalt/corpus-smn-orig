...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://papunet.net/sites/papunet.net/files/materiaalia/vuorotellen_inarinsaame_netti.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'VUÁRUTTUVÂI Raavâkirje vuáruvaikuttâsân já kielâ ovdánem algâmuddoid'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Kaisa'"/>
    <xsl:variable name="author1_ln" select="'Martikainen'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="publisher" select="'Tikoteekki'"/>
