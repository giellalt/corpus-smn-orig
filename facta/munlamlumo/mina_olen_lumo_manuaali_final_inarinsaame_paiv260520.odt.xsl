...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'Minä olen Lumo manuaali FINAL_inarinsaame_päiv260520.docx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Mun lam Lumo -roolâspellâ'"/>
    <!--
    ...
    <xsl:variable name="publisher" select="'JAMK University of Applied Sciences'"/>
