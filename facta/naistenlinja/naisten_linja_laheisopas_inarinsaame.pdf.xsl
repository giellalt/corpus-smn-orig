...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.naistenlinja.fi/wp-content/uploads/2018/06/Naisten_linja_l%C3%A4heisopas_INARINSAAME.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Uápistemloostâš viehâvääldi feerim ulmuu aldasij ulmui várás'"/>
    <!--
    ...
    <xsl:variable name="publisher" select="'Naisten linja'"/>
    ...
    <xsl:variable name="translator_fn" select="'Petter'"/>
    <xsl:variable name="translator_ln" select="'Morottaja'"/>
