...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://barbmu.wordpress.com/2016/09/14/tasiarvusub-samikiela-mattaattasmahdulasvuodah-uba-suoman/'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Täsiárvusub sämikielâ máttááttâsmáhđulâšvuođah ubâ Suomân'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Virpi'"/>
    <xsl:variable name="author1_ln" select="'Kulmala'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="publisher" select="'Bárbmu'"/>
