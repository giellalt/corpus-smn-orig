...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.valvira.fi/documents/14444/784076/Inarinsaamenkielinen+esite+potilaan+oikeudet.pdf/c876605e-59ea-b733-9f41-eff16176dd33?t=1600178565601'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Pyeccee vuoigâdvuođah'"/>
    <!--
    ...
    <xsl:variable name="publisher" select="'Valvira'"/>
