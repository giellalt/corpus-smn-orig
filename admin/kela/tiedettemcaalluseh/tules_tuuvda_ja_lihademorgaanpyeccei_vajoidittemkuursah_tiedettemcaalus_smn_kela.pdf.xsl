...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.kela.fi/documents/10180/24087143/TULES_tuuvda_ja_lihademorgaanpyeccei_vajoidittemkuursah_tiedettemcaalus_smn_Kela.pdf/b82ce7f2-4e3a-476d-b007-27240209a77a'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Tuuvdâ- já lihâdemorgaanpyeccei vajoidittemkuursah (TULES)'"/>
    <!--
    ...
    <xsl:variable name="publisher" select="'KELA'"/>
