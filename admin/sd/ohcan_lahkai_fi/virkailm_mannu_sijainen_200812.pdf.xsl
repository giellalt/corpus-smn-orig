...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Sämitigge almoot uuccâmnáál párnáikulttuurkuávdáátooimâstivrejeijee sajasâšvuođá ááigán 3.9.2012 – 20.5.2013'"/>
    <!--
    ...
    <xsl:variable name="top_margin" select="'2=12'"/>
