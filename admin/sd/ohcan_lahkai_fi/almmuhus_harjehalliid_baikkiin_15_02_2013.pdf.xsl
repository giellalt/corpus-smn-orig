...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Kulmâ hárjuttâllee saje uuccâmnáál Sämitige čäällimkoddeest Sajosist Anarist'"/>
...
<parallel_text location="almmuhus_harjehalliid_baikkiin_15_02_2013.pdf" xml:lang="fin"/>
    ...
    <xsl:variable name="top_margin" select="'4=12'"/>
    <xsl:variable name="bottom_margin" select="'4=48'"/>
