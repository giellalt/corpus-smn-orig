...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_docman&amp;task=doc_download&amp;gid=238&amp;Itemid=10'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sämikielâ toimâttuv já sämitige asâttem kielârääðI muštâlus säämi kielâlaavâ olášume iivijn 2004 -2006'"/>
...
<xsl:element name="p">
            ...
            <xsl:value-of select="translate($text,'ñ','đ') "/>
</xsl:element>
</xsl:template>
