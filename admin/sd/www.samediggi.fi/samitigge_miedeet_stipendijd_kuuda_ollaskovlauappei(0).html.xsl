...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2020/12/01/samitigge-miedeet-stipendijd-kuuda-ollaskovlauappei-2/?lang=an'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaiskarajien_stipendi_kuudelle_korkeakouluopiskelijalle(0).html"/>
        ...
        <parallel_text xml:lang="sme" location="samedikki_stipeanda_guda_allaskuvlastudentii(0).html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_mtee_gg_stipe_ndd_mie_dtum_kuud_ollskooulmatt_toottja.html"/>
