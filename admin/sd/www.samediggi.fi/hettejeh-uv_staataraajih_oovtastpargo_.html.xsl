...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2020/01/21/hettejeh-uv-staataraajih-oovtastpargo/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Hettejeh-uv staatârääjih oovtâstpargo? - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="haittaavatko_valtionrajat_yhteistyota_.html"/>
        ...
        <parallel_text xml:lang="sme" location="headustit_go_stahtarajat_ovttasbarggu_.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="lij-a_riikkraajin_hai_tt_ohttsaztuojju_.html"/>
