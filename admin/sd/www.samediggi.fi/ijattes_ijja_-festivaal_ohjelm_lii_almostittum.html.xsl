...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/07/02/ijattes-ijja-festivaal-ohjelm-lii-almostittum/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Ijâttes ijjâ -festivaal ohjelm lii almostittum - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="programme_for_ijahis_idja_-festival_is_published.html"/>
        <parallel_text xml:lang="fin" location="ijahis_idja_-festivaalin_ohjelma_on_julkaistu.html"/>
        ...
        <parallel_text xml:lang="sme" location="ijahis_idja_-festivala_programma_lea_almmustahtton.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="ijahis_idja_-fe_sttvaal_programm_lij_o_lmstottum.html"/>
