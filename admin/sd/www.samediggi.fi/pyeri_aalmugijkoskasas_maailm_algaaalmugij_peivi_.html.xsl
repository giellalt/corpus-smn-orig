...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2018/08/09/pyeri-aalmugijkoskasas-maailm-algaaalmugij-peivi/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Pyeri aalmugijkoskâsâš maailm algâaalmugij peivi! - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="international_day_of_the_world_s_indigenous_peoples_9_august.html"/>
        <parallel_text xml:lang="fin" location="hyvaa_kansainvalista_maailman_alkuperaiskansojen_paivaa_.html"/>
        ...
        <parallel_text xml:lang="sme" location="buori_riikkaidgaskasas_mailmmi_eamialbmogiid_beaivvi_.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="siogg_meeraikoskksaz_maai_lm_alggmeerai_peei_v_.html"/>
