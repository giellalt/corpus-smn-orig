...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2020/09/03/koijadallam-sosiaal-ja-tiervasvuodasyergi-aammatulmui-samikielan-ja-kulttuuran-lohtaseijee-mattimtaarbuin-vastidemaigi-22-9-2020-rai/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Koijâdâllâm sosiaal- já tiervâsvuođâsyergi áámmátulmui sämikielân já -kulttuurân lohtâseijee mättimtáárbuin – västidemäigi 22.9.2020 räi - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamen_kielten_ja_kulttuurin_osaamisesta_pulaa_sote-alalla_-_kyselylla_selvitetaan_taydennyskoulutuksen_tarvetta.html"/>
        ...
        <parallel_text xml:lang="sme" location="sode-suorggis_vatni_samegielaid_ja_kultuvrra_mahtuin_-_gazademiin_cielggadit_darbbu_dievasmahttinskuvlejupmai.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="koojjos_sosiaal-_da_tiorvasvuottsue_rj_ammatnii_kki_saa_mkiolid_da_kulttuu_re_ohttneei_siltteemtaarbin_-_va_stteemai_gg_22_9_2020_rajja_.html"/>
