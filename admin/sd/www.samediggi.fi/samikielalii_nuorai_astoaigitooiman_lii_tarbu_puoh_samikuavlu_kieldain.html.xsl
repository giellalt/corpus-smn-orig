...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/10/15/samikielalii-nuorai-astoaigitooiman-lii-tarbu-puoh-samikuavlu-kieldain/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sämikielâlii nuorâi astoäigitooimân lii tárbu puoh sämikuávlu kieldâin - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamenkieliselle_nuorten_vapaa-ajantoiminnalle_on_tarvetta_kaikissa_saamelaisalueen_kunnissa.html"/>
        ...
        <parallel_text xml:lang="sme" location="nuoraid_samegielat_asttuaiggedoibmii_lea_darbu_buot_sameguovllu_gielddain.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_mkiollsaz_nuori_luovasvuodtuaimmjummsa_lij_tarbb_pukin_saa_mvuu_d_koo_ddin.html"/>
