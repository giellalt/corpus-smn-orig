...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2020/12/01/saami-muusikkuavdas-pyevtittij-konsertvuarha-angelit-muusikjuavhoin/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Säämi muusikkuávdáš pyevtittij konsertvuárhá Angelit-muusikjuávhoin - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaismusiikkikeskus_tuotti_konserttitallenteen_angelit-yhtyeen_kanssa.html"/>
        ...
        <parallel_text xml:lang="sme" location="samemusihkkaguovddas_buvttadii_konseartabaddema_angelit-joavkkuin.html"/>
