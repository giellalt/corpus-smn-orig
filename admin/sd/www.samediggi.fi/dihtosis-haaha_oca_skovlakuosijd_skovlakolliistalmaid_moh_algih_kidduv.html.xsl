...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2018/11/06/dihtosis-haaha-oca-skovlakuosijd-skovlakolliistalmaid-moh-algih-kidduv/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Dihtosis-haahâ ocá škovlâkuosijd škovlâkolliistâlmáid moh älgih kiđđuv - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="dihtosis-hanke_hakee_kouluvierailijoita_kevaalla_starttaaviin_kouluvierailuihin.html"/>
        ...
        <parallel_text xml:lang="sme" location="dihtosis-proseakta_ohca_skuvlagalledeaddjiid_giddat_algi_skuvlagalledemiide.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="dihtosis-ha_ngkkos_aacc_skooulko_ll_jee_jid_keadda_aa_lji_skooulko_ll_jummsid.html"/>
