...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2020/12/15/samitigge-almoot-uuccamnaal-meriaigasas-kielapiervalstivrejeijee-pargo-2/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sämitigge almoot uuccâmnáál meriáigásâš kielâpiervâlstivrejeijee pargo - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaiskarajat_ilmoittaa_haettavaksi_maaraaikaisen_kielipesaohjaajan_tehtavan(0).html"/>
        ...
        <parallel_text xml:lang="sme" location="samediggi_almmuha_ohcanlahkai_mearreaigasas_giellabeassejodiheaddji_doaimma(0).html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_mte_gg_i_lmmat_ooccamnalla_mie_rraiggsaz_kiollpie_ssohjjeei_tuaj(0).html"/>
