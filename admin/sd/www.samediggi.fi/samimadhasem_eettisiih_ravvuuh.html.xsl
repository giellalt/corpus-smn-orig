...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/samimadhasem-eettisiih-ravvuuh/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sämimađhâšem eettisiih ravvuuh - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="ethical_guidelines_for_sami_tourism.html"/>
        <parallel_text xml:lang="fin" location="saamelaismatkailun_eettiset_ohjeet.html"/>
        ...
        <parallel_text xml:lang="sme" location="sameturismma_etihkalas_ravvagat.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_m-maatkcem_eettlaz_vua_pstoozz.html"/>
