...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2021/09/10/alemuu-rievti-miitaal-luovattui-samitiigan/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Alemuu rievti miitaal luovâttui Sämitiigán - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="korkeimman_oikeuden_mitali_luovutettiin_saamelaiskarajille.html"/>
        ...
        <parallel_text xml:lang="sme" location="alimus_rievtti_medallja_geigejuvvui_samediggai.html"/>
