...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2022/10/13/nuorairaadi-uarnee-nuoraiturnee/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Nuorâirääđi uárnee nuorâiturnee - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="nuorisoneuvosto_jarjestaa_nuorisokiertueen.html"/>
        ...
        <parallel_text xml:lang="sme" location="nuoraidraddi_lagida_nuoraidturnea.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="nuorisuavtos_jaa_rjast_nuorijoddi_.html"/>
