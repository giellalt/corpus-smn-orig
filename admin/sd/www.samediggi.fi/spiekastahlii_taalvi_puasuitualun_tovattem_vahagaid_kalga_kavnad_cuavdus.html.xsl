...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2020/08/27/spiekastahlii-taalvi-puasuitualun-tovattem-vahagaid-kalga-kavnad-cuavdus/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Spiekâstâhlii täälvi puásuituálun tovâttem vahâgáid kalga kavnâđ čuávdus - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="poikkeuksellisen_talven_poronhoidolle_aiheuttamiin_vahinkoihin_loydettava_ratkaisu.html"/>
        ...
        <parallel_text xml:lang="sme" location="spiehkkaseaddji_dalvvi_dagahan_boazodoallovahagiidda_galga_gavdnat_covdosa.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="naa_lte_mes_taa_lv_puazzhoiddu_tuejjtem_skaadaid_algg_kaunnad_cauddmoozz.html"/>
