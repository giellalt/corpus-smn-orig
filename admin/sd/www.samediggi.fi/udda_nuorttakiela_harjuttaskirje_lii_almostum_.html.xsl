...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2022/02/18/udda-nuorttakiela-harjuttaskirje-lii-almostum/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Uđđâ nuorttâkielâ hárjuttâskirje lii almostum  - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="uusi_koltansaamen_harjoituskirja_on_ilmestynyt_.html"/>
        ...
        <parallel_text xml:lang="sme" location="odda_bargogirji_nuortalasgillii_almmuhuvvon_.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="odd_saa_mkiol_kiddpaa_j_tuejjke_rjj_lij_olmstottum_.html"/>
