...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2023/03/21/barents-kuavlu-algaaalmugij-njunoscuakkim-brysselist/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Barents kuávlu algâaalmugij njunoščuákkim Brysselist  - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="barentsin_alueen_alkuperaiskansojen_huippukokous_brysselissa.html"/>
        ...
        <parallel_text xml:lang="sme" location="barents_guovllu_eamialbmogiid_allacoahkkin_brysselis_.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="bareents_vuu_d_alggmeerai_jonnsaabbar_brysslest_.html"/>
