...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2022/04/05/mija-tekno-kielateknologiaseminaar-luuleest/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Mijá tekno -kielâteknologiaseminaar Luuleest - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="mija_tekno_-kieliteknologiaseminaari_luulajassa.html"/>
        ...
        <parallel_text xml:lang="sme" location="mija_tekno_giellateknologiijaseminara_lulejus.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="mija_tekno_-kiollteknologiaseminaar_juu_lvest.html"/>
