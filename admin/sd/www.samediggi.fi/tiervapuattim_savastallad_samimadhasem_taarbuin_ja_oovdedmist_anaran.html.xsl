...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/04/15/tiervapuattim-savastallad-samimadhasem-taarbuin-ja-oovdedmist-anaran/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Tiervâpuáttim savâstâllâđ sämimađhâšem táárbuin já oovdedmist Anarân - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="tervetuloa_keskustelemaan_saamelaismatkailun_tarpeista_ja_kehittamisesta_inariin.html"/>
        ...
        <parallel_text xml:lang="sme" location="bures_boahtin_sagastallat_sameturismma_darbbuin_ja_ovddideamis_anarii.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="tiorv_pue_ttmest_sagstoollad_saa_m-maatkcem_taarbin_da_ooudasviikkmest_aanra.html"/>
