...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2018/04/20/kesikumikampanja-kondomeh-meid-kuulma-samikielan/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Kesikumikampanja kondomeh meid kuulmâ sämikielân - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="kesakumikampanjan_kondomit_myos_kolmelle_saamen_kielelle.html"/>
        ...
        <parallel_text xml:lang="sme" location="geassekummekampanjja_kondomat_maiddai_golmma_samegillii.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="kie_sskumikampanja_kondoom_se_koolm_saa_mkio_lle.html"/>
