...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/02/26/torjuuh-moh-maksojeh-saami-kielalaava-31-%C2%A7-vuaduld/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Torjuuh, moh máksojeh säämi kielâlaavâ 31 § vuáđuld, láá uuccâmnáál - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamen_kielilain_31_ss:n_mukaiset_avustukset_haettavana(0).html"/>
        ...
        <parallel_text xml:lang="sme" location="sami_giellalaga_31_ss:a_vuodul_maksojuvvon_doarjagat_ohcanlahkai(0).html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_m_kioll-laa_jj_31_ss_mealdlaz_vie_kktoozz_ooccamnalla.html"/>
