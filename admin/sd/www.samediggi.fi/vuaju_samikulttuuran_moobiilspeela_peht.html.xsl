...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2020/01/31/vuaju-samikulttuuran-moobiilspeela-peht/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Vuáju sämikulttuurân moobiilspeelâ peht - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="sukella_saamelaiskulttuuriin_mobiilipelin_muodossa.html"/>
        ...
        <parallel_text xml:lang="sme" location="oahpasmuva_samekultuvrii_mobiilaspealu_bokte.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="caangngal_saa_mkulttuu_re_mobiilsior_aa_blkest.html"/>
