...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2020/09/30/mattaattas-ja-kulttuurministeriost-ruttadem-dihtosis-haava-kualmad-ihan/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Máttááttâs- já kulttuurministeriöst ruttâdem Dihtosis-haavâ kuálmád ihán - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="opetus-_ja_kulttuuriministeriolta_rahoitus_dihtosis-hankkeen_kolmannelle_vuodelle.html"/>
        ...
        <parallel_text xml:lang="sme" location="oahpahus-_ja_kulturministeriijas_ruhtadeapmi_dihtosis-fitnu_goalmmat_jahkai.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="matt_tos-_da_kulttuurministeriast_teaggtos_dihtosis-ha_ngkkoozz_kualmad_ekka.html"/>
