...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2022/08/09/samitigge-sirda-komissaarij-valjim-ovdaskulij/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sämitigge sirdá komissaarij valjim ovdâskulij - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaiskarajat_siirtaa_komissaarien_valintaa_eteenpain.html"/>
        ...
        <parallel_text xml:lang="sme" location="samediggi_sirda_komissaraid_valljema_ovddos_guvlui.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_mte_gg_serdd_komissaari_va_lljummuz_ooudarra.html"/>
