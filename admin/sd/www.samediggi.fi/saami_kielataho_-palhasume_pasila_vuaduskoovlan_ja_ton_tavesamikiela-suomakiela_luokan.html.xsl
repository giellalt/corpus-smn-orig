...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/12/17/saami-kielataho-palhasume-pasila-vuaduskoovlan-ja-ton-tavesamikiela-suomakiela-luokan/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Säämi kielâtaho -PALHÂŠUME Pasila vuáđuškoovlân já ton tavesämikielâ-suomâkielâ luokan - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamen_kieliteko_-palkinto_pasilan_peruskoululle_ja_sen_pohjoissaame-suomi_luokalle.html"/>
        ...
        <parallel_text xml:lang="sme" location="sami_gielladahku_-balkkasupmi_pasila_vuoddoskuvlii_ja_dan_davvisamegiella-suomagiella_luohkkai.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_m_kiolltuajj_-pa_lkkummus_pasila_vuaddskoou_le_da_ton_ta_vvsaa_m-laa_dd_kla_sse.html"/>
