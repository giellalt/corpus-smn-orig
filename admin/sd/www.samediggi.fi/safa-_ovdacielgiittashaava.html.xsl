...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/samikiela/safa-ovdacielgiittashaava/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'SáFá- ovdâčielgiittâshaavâ - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="safa_-esiselvityshanke.html"/>
        ...
        <parallel_text xml:lang="sme" location="safa_-_davviriikkalas_sami_giellafagaguovddaza_asaheami_cielggadus.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="safa_-ouddcio_lggeemha_ngkkos.html"/>
