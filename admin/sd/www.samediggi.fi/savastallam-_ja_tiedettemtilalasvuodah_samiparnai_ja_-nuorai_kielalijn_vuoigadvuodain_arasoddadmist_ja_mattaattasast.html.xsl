...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2022/02/11/savastallam-ja-tiedettemtilalasvuodah-samiparnai-ja-nuorai-kielalijn-vuoigadvuodain-arasoddadmist-ja-mattaattasast/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Savâstâllâm- já tieđettemtilálâšvuođah sämipárnái já –nuorâi kielâlijn vuoigâdvuođâin arâšoddâdmist já máttááttâsâst - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="keskustelu-_ja_tiedotustilaisuuksia_saamelaislasten_ja_-nuorten_kielellisista_oikeuksista_varhaiskasvatuksessa_ja_opetuksessa.html"/>
        ...
        <parallel_text xml:lang="sme" location="sagastallan-_ja_diedihandilalasvuodat_samemanaid_ja_-nuoraid_gielalas_vuoigatvuodain_arrabajasgeassimis_ja_oahpahusas.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="sagstoollam-_da_teadtempoodd_saa_mpaarnai_da_-nuori_kiol_laz_vuoiggadvuodin_ouddpeammast_da_matt_toozzast.html"/>
