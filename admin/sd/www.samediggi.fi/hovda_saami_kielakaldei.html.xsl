...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2020/10/06/hovda-saami-kielakaldei/?lang=an'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="johtaja_sami_giellagalduun.html"/>
        ...
        <parallel_text xml:lang="sms" location="jaa_dteei_saa_m_kiollka_lddja.html"/>
