...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2023/04/04/saminuorai-taaidatabahtus-aldan-laavdastmij-almottem-sehe-uasalistem-pargopaajaid-lii-taal-avus/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Säminuorâi taaiđâtábáhtus aldan – láávdástmij almottem sehe uásálistem pargopáájáid lii tääl ávus - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaisnuorten_taidetapahtuma_lahestyy_-_esityksien_ilmoittaminen_seka_osallistuminen_tyopajoihin_on_nyt_auki.html"/>
        ...
        <parallel_text xml:lang="sme" location="samenuoraid_daiddadahpahus_lahkona_-_dal_sahtta_almmuhit_loaiddastemiin_ja_maiddai_oassalastimis_bargobajiide.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_mnuori_cea_ppvuottpei_vv_alddan_-_cuajtoozzi_i_lmmtummus_di_vuassoottmos_tuajjpaa_jid_lij_aa_n_aavai.html"/>
