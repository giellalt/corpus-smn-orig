...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2018/06/04/lappi-eennamkoddeudasmittem-koijadallam/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Lappi eennâmkoddeuđâsmittem - Koijâdâllâm palvâlusâi kevttimist já puátteevuođâ palvâlustáárbuin - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="lappi_maakuntauudistus_-_kysely_palvelujen_kaytosta_ja_tulevaisuuden_palvelutarpeista.html"/>
        ...
        <parallel_text xml:lang="sme" location="lappi_eanagoddeodastus_-_jearahallan_balvalusaid_geavaheamis_ja_boahttevuoda_balvalandarbbuin.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="lappi_maddka_ddoodos_-_koojjos_kaazzkoozzi_aa_nnem_da_puo_ttiaai_j_kaazzka_sttemtaarbi_pirr.html"/>
