...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2022/11/04/skovlimtilalasvuota-sammilij-vuoigadvuodai-huammasuman-valdimist-kiasuttij-ennuv-ulmuid/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Škovlimtilálâšvuotâ sämmilij vuoigâdvuođâi huámmášumán väldimist kiäsuttij ennuv ulmuid - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="koulutustilaisuus_saamelaisten_oikeuksien_huomioimisesta_kerasi_runsaasti_osallistujia.html"/>
        ...
        <parallel_text xml:lang="sme" location="skuvlendilalasvuohta_samiid_vuoigatvuodaid_vuhtii_valdimis_cohkkii_olu_oassalastiid.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="skooultempodd_saa_mi_vuoiggadvuodi_lokku_valddmoozzast_noori_vaa_ljest_vuassoodjid.html"/>
