...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/12/12/raapoort-raajijd-rasteldittee-skovlaohtsaspargoost-almostui/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Raapoort raajijd rasteldittee skovlâohtsâšpargoost almostui - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="raportti_rajat_ylittavasta_kouluyhteistyosta_julkistettiin.html"/>
        ...
        <parallel_text xml:lang="sme" location="raporta_raja_rasttildeaddji_skuvlaovttasbarggu_birra_almmuhuvvui.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="raaji_rastldeei_skooulohttsaztuaj_raportt_olmmuum.html"/>
