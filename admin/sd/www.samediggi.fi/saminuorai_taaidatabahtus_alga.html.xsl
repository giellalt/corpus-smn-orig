...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/04/10/saminuorai-taaidatabahtus-alga/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Säminuorâi taaiđâtábáhtus álgá - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaisnuorten_taidetapahtuma_kaynnistyy.html"/>
        ...
        <parallel_text xml:lang="sme" location="samenuoraid_daiddadahpahus_alga.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_mnuori_cea_ppvuodpeei_v_a_lgge.html"/>
