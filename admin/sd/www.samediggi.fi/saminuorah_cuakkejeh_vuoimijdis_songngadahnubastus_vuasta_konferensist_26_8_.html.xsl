...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2021/08/23/saminuorah-cuakkejeh-vuoimijdis-sonnadahnubastus-vuasta-konferensist-26-8/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Säminuorah čuákkejeh vuoimijdis šoŋŋâdâhnubástus vuástá konferensist 26.8. - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="sami_youth_come_together_to_fight_climate_change_in_a_conference_on_26_august.html"/>
        <parallel_text xml:lang="fin" location="saamelaisnuoret_kokoavat_voimansa_ilmastonmuutosta_vastaan_konferenssissa_26_8_.html"/>
        ...
        <parallel_text xml:lang="sme" location="samenuorat_cohkkejit_famuideaset_dalkkadatrievdama_vuosta_konferanssas_26_8_.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_mnuor_na_rre_vioggees_aimmosmuuttas_vuastta_konferee_nsest_26_8_.html"/>
