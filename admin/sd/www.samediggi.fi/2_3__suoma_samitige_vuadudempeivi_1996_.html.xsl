...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2020/03/02/2-3-suoma-samitige-vuadudempeivi-1996/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'2.3. Suomâ Sämitige vuáđudempeivi (1996) - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="2_3__suomen_saamelaiskarajien_perustamispaiva_1996_.html"/>
        ...
        <parallel_text xml:lang="sme" location="2_3__suoma_samedikki_vuoddudanbeaivi_1996_.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="2_3__laa_ddjannam_saa_mtee_gg_vuaddeempei_vv_1996_.html"/>
