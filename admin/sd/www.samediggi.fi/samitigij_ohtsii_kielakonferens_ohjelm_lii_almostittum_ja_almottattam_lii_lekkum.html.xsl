...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/09/11/samitigij-ohtsii-kielakonferens-ohjelm-lii-almostittum-ja-almottattam-lii-lekkum/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sämitigij ohtsii kielâkonferens ohjelm lii almostittum já almottâttâm lii lekkum - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaiskarajien_yhteisen_kielikonferenssin_ohjelma_julkaistu_ja_ilmoittautuminen_on_avattu.html"/>
        ...
        <parallel_text xml:lang="sme" location="samedikkiid_giellaseminara_programma_almmustuvvan_ja_almmuheapmi_lea_rahppon.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_mtii_ggi_ohttsaz_kiollkonferee_ns_programm_olmstottum_da_i_lmmtoottmos_lij_aavuum.html"/>
