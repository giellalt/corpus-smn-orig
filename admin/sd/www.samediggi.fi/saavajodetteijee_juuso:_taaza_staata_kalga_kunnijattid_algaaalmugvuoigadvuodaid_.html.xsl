...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2023/03/02/saavajodetteijee-juuso-taaza-staata-kalga-kunnijattid-algaaalmugvuoigadvuodaid/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Saavâjođetteijee Juuso: “Taažâ staatâ kalga kunnijâttiđ algâaalmugvuoigâdvuođâid” - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="president_juuso:_the_state_of_norway_must_respect_the_rights_of_indigenous_people_.html"/>
        <parallel_text xml:lang="fin" location="puheenjohtaja_juuso:_norjan_valtion_kunnioitettava_alkuperaiskansaoikeuksia_.html"/>
        ...
        <parallel_text xml:lang="sme" location="sagajodiheaddji_juuso:_norgga_stahta_galga_gudnejahttit_eamialbmotvuoigatvuodaid_.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saaggjaa_dtee_jj_juuso:_taarr_riikk_algg_ci_sttjed_alggmeervuoiggadvuodid_.html"/>
