...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2021/10/05/tiervapuattim-konferensan-tave-enamij-algaaalmugij-arbitiadu-syejeest-ja-immateriaallii-omaduvast/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Tiervâpuáttim konferensân Tave-enâmij algâaalmugij ärbitiäđu syejeest já immateriaallii omâduvâst - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="welcome_to_the_conference_on_protection_of_nordic_indigenous_traditional_knowledge_and_intellectual_property_on_11_november_2021.html"/>
        <parallel_text xml:lang="fin" location="tervetuloa_konferenssiin_pohjoismaiden_alkuperaiskansojen_perinteisen_tiedon_suojasta_ja_aineettomasta_omaisuudesta_11_11_2021.html"/>
        ...
        <parallel_text xml:lang="sme" location="bures_boahtin_konferensii_davviriikkaid_eamialbmogiid_arbevirolas_diedu_suojis_ja_avnnahis_opmodagas_11_11_2021.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="tiorv_pue_ttmest_konferenssa_ta_vvjannmi_alggmeerai_a_rbbvuodlaz_tead_suojast_da_aaunaste_mes_jallmoozzast_11_11_2021.html"/>
