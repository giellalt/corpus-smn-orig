...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2022/06/03/samitigge-palhasij-samikielai-tyeje-ja-puasuitualu-uappeid-2/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sämitigge palhâšij sämikielâi, tyeje já puásuituálu uáppeid  - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaiskarajat_palkitsi_saamen_kielten_saamelaisen_kasityon_ja_poronhoidon_opiskelijoita(0).html"/>
        ...
        <parallel_text xml:lang="sme" location="samediggi_balkkasii_samegielaid_sami_duoji_ja_boazodoalu_studeanttaid_.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_mte_gg_pa_lkkii_saa_mkioli_saa_m_kiott-tuej_da_puazzhaaid_matt_toottjid(0).html"/>
