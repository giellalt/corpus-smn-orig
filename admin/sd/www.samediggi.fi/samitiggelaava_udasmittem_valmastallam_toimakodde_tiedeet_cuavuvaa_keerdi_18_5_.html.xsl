...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2018/05/11/samitiggelaava-udasmittem-valmastallam-toimakodde-tiedeet-cuavuvaa-keerdi-18-5/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sämitiggelaavâ uđâsmittem valmâštâllâm toimâkodde tieđeet čuávuváá keerdi 18.5. - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaiskarajalain_muutosta_valmisteleva_toimikunta_tiedottaa_seuraavan_kerran_18_5_.html"/>
        ...
        <parallel_text xml:lang="sme" location="samediggelaga_nuppastusa_valmmastalli_doaibmagoddi_diediha_cuovvovas_have_18_5_.html"/>
