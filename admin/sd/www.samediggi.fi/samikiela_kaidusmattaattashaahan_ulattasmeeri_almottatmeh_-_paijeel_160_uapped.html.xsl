...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2022/04/08/samikiela-kaidusmattaattashaahan-ulattasmeeri-almottatmeh-paijeel-160-uapped/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sämikielâ káidusmáttááttâshaahân ulâttâsmeeri almottâtmeh – paijeel 160 uápped - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamen_kielten_etaopetushankkeeseen_ennatysmaara_ilmoittautuneita_-_yli_160_oppilasta_ja_opiskelijaa.html"/>
        ...
        <parallel_text xml:lang="sme" location="samegielaid_gaiddusoahpahusfidnui_almmuheddjiid_mearis_olahus_-_badjelas_160_oahppi_ja_studeantta.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_mkioli_ougglosmatt_tosha_ngkko_sse_jonnmie_rr_i_lmmtoottam_-_pa_jjel_160_skooulnee_kk_da_matt_toodi.html"/>
