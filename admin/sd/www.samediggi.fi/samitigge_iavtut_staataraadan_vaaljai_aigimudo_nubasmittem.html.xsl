...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/06/18/samitigge-iavtut-staataraadan-vaaljai-aigimudo-nubasmittem/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sämitigge iävtut staatârááđán vaaljâi äigimudo nubásmittem - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaiskarajat_esittaa_valtioneuvostolle_saamelaiskarajien_vaalien_ajankohdan_muuttamista.html"/>
        ...
        <parallel_text xml:lang="sme" location="samediggi_evttoha_stahtaraddai_samediggevalggaid_aiggi_nuppastuhttima.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_mte_gg_e_tkkad_riikksuavto_sse_saa_mtee_gg_vaali_aai_j_mottmoozz.html"/>
