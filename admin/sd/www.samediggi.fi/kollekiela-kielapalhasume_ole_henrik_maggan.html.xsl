...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2023/01/20/kollekiela-kielapalhasume-ole-henrik-maggan/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Kollekielâ-kielâpalhâšume Ole Henrik Maggan - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="gollegiella-kielipalkinto_ole_henrik_maggalle.html"/>
        ...
        <parallel_text xml:lang="sme" location="gollegiella-giellabalkkasupmi_ole_henrik_maggai.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="gollegiella-kiollcistt_ole_henrik_maggaa_je.html"/>
