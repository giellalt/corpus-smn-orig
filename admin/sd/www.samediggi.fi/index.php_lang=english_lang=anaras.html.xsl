...
<xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?lang=english&amp;lang=anaras'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="index.php_lang=english_lang=finnish.html" xml:lang="fin"/>
</xsl:variable>
