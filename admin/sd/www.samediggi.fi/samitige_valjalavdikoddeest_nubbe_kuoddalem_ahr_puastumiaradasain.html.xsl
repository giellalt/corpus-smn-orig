...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/08/29/samitige-valjalavdikoddeest-nubbe-kuoddalem-ahr-puastumiaradasain/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sämitige valjâlävdikoddeest nubbe kuoddâlem AHR puástumiärádâsâin - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaiskarajien_vaalilautakunnalta_toinen_kantelu_kho:n_virheellisista_paatoksista.html"/>
        ...
        <parallel_text xml:lang="sms" location="saa_mtee_gg_vaal-lu_vddkaa_ddest_nu_bb_kue_ddlummus_kho_puast_tu_mmstooggin.html"/>
