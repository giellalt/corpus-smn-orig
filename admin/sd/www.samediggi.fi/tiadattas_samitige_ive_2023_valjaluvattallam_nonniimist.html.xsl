...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2023/03/16/tiadattas-samitige-ive-2023-valjaluvattallam-nonniimist/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Tiäđáttâs sämitige ive 2023 valjâluvâttâllâm nonniimist - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="tiedote_saamelaiskarajien_vuoden_2023_vaaliluettelon_vahvistamiseen_liittyen.html"/>
        ...
        <parallel_text xml:lang="sme" location="diedahus_samedikki_jagi_2023_valgalogahallama_nannemis.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="teadtos_saa_mtee_gg_ee_jj_2023_vaal-logstoogg_raavummsa_kuulee_l.html"/>
