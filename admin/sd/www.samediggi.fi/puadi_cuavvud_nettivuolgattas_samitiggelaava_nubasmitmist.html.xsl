...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2021/05/31/puadi-cuavvud-nettivuolgattas-samitiggelaava-nubasmitmist/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Puáđi čuávvuđ nettivuolgâttâs sämitiggelaavâ nubásmitmist - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="tule_seuraamaan_verkkolahetysta_saamelaiskarajalain_muutoksesta.html"/>
        ...
        <parallel_text xml:lang="sme" location="boade_cuovvut_neahttasaddaga_samediggelaga_nuppastusa_birra.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="pua_d_seu_rrjed_ne_ttvuolttoozz_saa_mte_gglaa_jj_muttsest.html"/>
