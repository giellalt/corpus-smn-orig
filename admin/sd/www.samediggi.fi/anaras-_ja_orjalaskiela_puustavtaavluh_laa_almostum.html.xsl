...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/06/24/anaras-ja-orjalaskiela-puustavtaavluh-laa-almostum/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Anarâš- já orjâlâškielâ puustavtaavluh láá almostum - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="inarin-_ja_pohjoissaamen_aakkoskuvataulut_ilmestyivat.html"/>
        ...
        <parallel_text xml:lang="sme" location="anaras-_ja_davvisamegiela_bustavvatavvalat_leat_almmustuvvan.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="aanar-_da_ta_vvsaa_mkiol_alfabe_tt-taaul_kaartivui_m_i_lmsto_vve.html"/>
