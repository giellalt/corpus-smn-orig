...
<xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?lang=nuortta&amp;lang=anaras'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="index.php_lang=nuortta_lang=finnish.html" xml:lang="fin"/>
</xsl:variable>
