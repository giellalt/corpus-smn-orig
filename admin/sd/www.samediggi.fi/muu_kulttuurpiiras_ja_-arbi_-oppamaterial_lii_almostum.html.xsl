...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2021/08/18/muu-kulttuurpiiras-ja-arbi-oppamaterial-lii-almostum/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Muu kulttuurpiirâs já -ärbi -oppâmaterial lii almostum - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="minun_kulttuuriymparistoni_ja_-perintoni_-oppimateriaali_on_ilmestynyt.html"/>
        ...
        <parallel_text xml:lang="sme" location="mu_kulturbiras_ja_-arbi_oahppomateriala_lea_almmustuvvan.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="muu_kulttuurpirros_da_-a_rbb_-mattmateriaal_lij_i_lmstoovvam.html"/>
