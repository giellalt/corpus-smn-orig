...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/05/14/adde-macattas-samikielai-kaidusmattaattasast/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Adde macâttâs sämikielâi káidusmáttááttâsâst! - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="anna_palautetta_saamen_kielten_etaopetuksesta_.html"/>
        ...
        <parallel_text xml:lang="sme" location="atte_mahcahaga_samegielaid_gaiddusoahpahusas_.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="uu_d_maacctoozz_saa_mkioli_ougglosmatt_toozzast_.html"/>
