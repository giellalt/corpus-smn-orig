...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2021/02/04/saami-parlamentaarlas-raadi-adelij-julgastas-pieggavyeimi-pyevtitmist-samikuavluin-haavain-kalga-lede-sammilij-rijja-tiatun-vuaduduvvee-munemietamas/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Säämi parlamentaarlâš rääđi adelij julgáštâs pieggâvyeimi pyevtitmist sämikuávluin – Haavâin kalga leđe sämmilij rijjâ, tiätun vuáđuduvvee munemietâmâš - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="the_sami_parliamentary_council_s_statement_on_wind_power_projects_in_sami_areas_-_projects_must_obtain_a_free_prior_and_informed_consent_of_the_sami_people.html"/>
        <parallel_text xml:lang="fin" location="saamelainen_parlamentaarinen_neuvosto_antoi_julkilausuman_tuulivoiman_tuotannosta_saamelaisalueilla_-_hankkeilla_tulee_olla_saamelaisten_vapaa_tietoon_perustuva_ennakkosuostumus.html"/>
        ...
        <parallel_text xml:lang="sme" location="sami_parlamentalas_raddi_spr_attii_cealkamusa_bieggafamu_buvttadeamis_sameguovlluin_-_proseavttain_galga_leat_samiid_friddja_dihtui_vuoddudeaddji_ovdamiehtan.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_m_parlamentaarlaz_suavtos_uu_di_oolmascea_lkkem_pioggviogg_puu_t_tem_pirr_saa_mvuu_din_-_ha_ngkkoozzin_algg_lee_d_sa_mmlai_luovas_tiottu_vuaddoovvi_ouddmiasttmos.html"/>
