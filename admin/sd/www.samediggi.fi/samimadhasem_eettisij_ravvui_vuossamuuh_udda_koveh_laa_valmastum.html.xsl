...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/07/11/samimadhasem-eettisij-ravvui-vuossamuuh-udda-koveh-laa-valmastum/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sämimađhâšem eettisij ravvui vuossâmuuh uđđâ koveh láá valmâštum - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="the_first_new_illustrations_of_the_ethical_guidelines_of_sami_tourism_have_been_released.html"/>
        <parallel_text xml:lang="fin" location="saamelaismatkailun_eettisten_ohjeiden_ensimmaiset_uudet_kuvituskuvat_ovat_valmistuneet.html"/>
        ...
        <parallel_text xml:lang="sme" location="sameturismma_etihkalas_ravvagiid_vuosttas_odda_govat_leat_garvanan.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_m-maatkcem_eettlaz_vua_pstoozzi_vuossmos_odd_karttoskaart_lie_valmstoovvam.html"/>
