...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2023/02/14/etyj-ucceeblohovaldalas-kuallee-anarist/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Etyj ucceeblohováldálâš kuállee Anarist - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="osce_high_commissioner_on_national_minorities_to_visit_inari.html"/>
        <parallel_text xml:lang="fin" location="etyjin_vahemmistovaltuutettu_vierailee_inarissa_.html"/>
        ...
        <parallel_text xml:lang="sme" location="etyj:a_vehadataittardeaddji_galleda_anaris.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="etyj_minorite_ttvaldduumnek_kuo_ssai_aanrest.html"/>
