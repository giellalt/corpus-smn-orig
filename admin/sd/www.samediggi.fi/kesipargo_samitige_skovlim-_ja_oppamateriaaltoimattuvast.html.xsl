...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/05/22/kesipargo-samitige-skovlim-ja-oppamateriaaltoimattuvast/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Kesipargo Sämitige škovlim- já oppâmateriaaltoimâttuvâst - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="kesatyota_saamelaiskarajien_koulutus-_ja_oppimateriaalitoimistolla.html"/>
        ...
        <parallel_text xml:lang="sme" location="geassebargu_samedikki_skuvlen-_ja_oahppamaterialadoaimmahagas.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="kie_sstuejj_saa_mtee_gg_skooultos-_da_mattmateriaalkonttrest.html"/>
