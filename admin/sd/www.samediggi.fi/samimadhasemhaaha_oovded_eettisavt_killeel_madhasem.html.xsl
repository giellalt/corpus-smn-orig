...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2018/09/19/samimadhasemhaaha-oovded-eettisavt-killeel-madhasem/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sämimađhâšemhaahâ oovded eettisávt killeel mađhâšem - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaismatkailuhanke_edistaa_eettisesti_kestavaa_matkailua.html"/>
        ...
        <parallel_text xml:lang="sme" location="sameturismaproseakta_ovddida_etihkalaccat_suvdilis_turismma.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_m-maatkcemha_ngkkos_ooudad_eettlanji_keall_jeei_maatkcummuz.html"/>
