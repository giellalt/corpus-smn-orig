...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2021/04/15/samikielalii-arasoddadem-samimattaattas-ja-samikielalii-skovlimpalgai-nanodem-finnee-taal-udda-liavtu/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'“Sämikielâlii arâšoddâdem, sämimáttááttâs já sämikielâlii škovlimpálgái nanodem finnee tääl uđđâ liävtu” - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="_saamenkielisen_varhaiskasvatuksen_saamelaisopetuksen_ja_saamenkielisten_koulutuspolkujen_vahvistaminen_saa_nyt_uutta_vauhtia_.html"/>
        ...
        <parallel_text xml:lang="sme" location="_samegielat_arrabajasgeassima_sameoahpahusa_ja_samegielat_skuvlenbalgaid_nannen_beassa_dal_odda_fartii_.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="_saa_mkiollsaz_ouddpeamm_saa_m-matt_toozz_da_saa_mkiollsai_skooultospalggsi_naanummus_vuazhzh_aa_n_odd_hoodd_.html"/>
