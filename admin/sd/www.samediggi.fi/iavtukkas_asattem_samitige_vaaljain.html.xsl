...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/06/12/iavtukkas-asattem-samitige-vaaljain/?lang=an'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="ehdokkaan_asettaminen_saamelaiskarajien_vaaleissa.html"/>
        ...
        <parallel_text xml:lang="sme" location="evttohasa_asaheapmi_samedikki_valggain.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="voborsee_kk_piijjmos_saa_mte_ggvaalin.html"/>
