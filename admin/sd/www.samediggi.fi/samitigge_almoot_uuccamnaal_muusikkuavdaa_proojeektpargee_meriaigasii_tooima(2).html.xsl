...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2021/05/10/samitigge-almoot-uuccamnaal-muusikkuavdaa-proojeektpargee-meriaigasii-tooima-3/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sämitigge almoot uuccâmnáál muusikkuávdáá proojeektpargee meriáigásii tooimâ - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaiskarajat_ilmoittaa_haettavaksi_musiikkikeskuksen_projektityontekijan_maaraaikaisen_tehtavan(1).html"/>
        ...
        <parallel_text xml:lang="sme" location="samediggi_almmuha_ohcanlahkai_musihkkaguovddaza_proseaktabargi_mearreaigasas_doaimma(1).html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_mte_gg_i_lmmat_ooccamnalla_musikk-kooskoozz_proje_ktt-tuajjla_mie_rraiggsaz_tuaj(1).html"/>
