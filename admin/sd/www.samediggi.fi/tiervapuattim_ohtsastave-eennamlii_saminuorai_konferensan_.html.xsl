...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2021/08/17/tiervapuattim-ohtsastave-eennamlii-saminuorai-konferensan/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Tiervâpuáttim ohtsâštave-eennâmlii säminuorâi konferensân! - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="welcome_to_the_nordic_sami_youth_conference.html"/>
        <parallel_text xml:lang="fin" location="tervetuloa_pohjoismaiseen_saamelaisnuorten_konferenssiin_.html"/>
        ...
        <parallel_text xml:lang="sme" location="bures_boahtin_davviriikkalas_samenuoraid_konferansii_.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="tiorvvpue_ttem_ta_vvjannmallso_zze_saa_mnuori_konferenssa_.html"/>
