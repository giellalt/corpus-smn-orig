...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2023/06/09/giellaleaika-eenikiela-oppakirjij-saniruossalasai-vastadasah-laa-almostittum/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Giellaleaika - eenikielâ oppâkirjij säniruossâlâsâi vástádâsah láá almostittum - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="giellaleaika_-_aidinkielen_oppikirjojen_sanaristikoiden_vastaukset_on_julkaistu.html"/>
        ...
        <parallel_text xml:lang="sme" location="giellaleaika_-_eatnigiela_oahppogirjjiid_satneruvttohasaide_vastadusat_leat_almmuhuvvon.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="vastoozz_giellaleaika_-_jie_nnkiol_mattkii_rji_saa_nnruossoozzinlij_olmstottum_.html"/>
