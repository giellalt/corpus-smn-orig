...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2020/08/20/aalmuglas-ja-aalmugijkoskasas-samikielai-okko-2020/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Aalmuglâš já aalmugijkoskâsâš sämikielâi okko 2020 - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="kansallinen_ja_kansainvalinen_saamen_kielten_viikko_2020.html"/>
        ...
        <parallel_text xml:lang="sms" location="meersaz_da_meeraikoskksaz_saa_mkioli_nea_ttel_2020.html"/>
