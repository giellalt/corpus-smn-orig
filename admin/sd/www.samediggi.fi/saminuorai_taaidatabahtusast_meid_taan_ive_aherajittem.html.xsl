...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2023/02/23/saminuorai-taaidatabahtusast-meid-taan-ive-aherajittem-samitige-stivra-miedettij-laseruttadem/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Säminuorâi taaiđâtábáhtusâst meid taan ive aheräjittem - Sämitige stivrâ mieđettij laseruttâdem - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaisnuorten_taidetapahtumasta_myos_tana_vuonna_ikarajaton.html"/>
        ...
        <parallel_text xml:lang="sme" location="samenuoraid_daiddadahpahus_lea_maiddai_dan_jagi_ahkeraddjemeahttun.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_mnuori_cea_ppvuottpeei_vest_se_tan_ee_jj_aa_kkraajtem.html"/>
