...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2018/10/29/nuorttalaskiela-puustavvideo-lii-vaalmas/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Nuorttâlâškielâ puustavvideo lii vaalmâš - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="koltansaamen_kielen_aakkosvideo_valmistui.html"/>
        ...
        <parallel_text xml:lang="sme" location="nuortalasgielat_alfabehtavideo_lea_valmmas.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="alfabe_ttvideo_nuorttsaamas_lij_vaalmas.html"/>
