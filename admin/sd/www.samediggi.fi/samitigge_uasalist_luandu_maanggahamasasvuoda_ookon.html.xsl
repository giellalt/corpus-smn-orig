...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2020/05/18/samitigge-uasalist-luandu-maangahamasasvuoda-ookon/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sämitigge uásálist luándu maaŋgâhámásâšvuođâ ookon - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="the_sami_parliament_participates_in_the_international_week_for_biological_diversity.html"/>
        <parallel_text xml:lang="fin" location="saamelaiskarajat_osallistuu_luonnon_monimuotoisuuden_viikkoon.html"/>
        ...
        <parallel_text xml:lang="sme" location="samediggi_oassalasta_luonddu_mangggahamatvuoda_vahkkui.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_mte_gg_vuassaatt_luad_maangghammsazvuod_nea_ttla.html"/>
