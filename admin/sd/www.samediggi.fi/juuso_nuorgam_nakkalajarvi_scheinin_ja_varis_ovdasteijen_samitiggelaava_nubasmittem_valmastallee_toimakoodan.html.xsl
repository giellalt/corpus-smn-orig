...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2020/07/06/juuso-nuorgam-nakkalajarvi-scheinin-ja-varis-ovdasteijen-samitiggelaava-nubasmittem-valmastallee-toimakoodan/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Juuso, Nuorgam, Näkkäläjärvi, Scheinin ja Varis ovdâsteijen sämitiggelaavâ nubásmittem valmâštâllee toimâkoodán - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="juuso_nuorgam_nakkalajarvi_scheinin_ja_varis_edustajiksi_saamelaiskarajalain_muuttamista_valmistelevaan_toimikuntaan.html"/>
        ...
        <parallel_text xml:lang="sme" location="juuso_nuorgam_nakkalajarvi_scheinin_ja_varis_ovddasteaddjin_samediggelaga_rievdadeami_valmmastalli_doaibmagoddai.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="juuso_nuorgam_nakkalajarvi_scheinin_da_varis_ee_ttkee_jen_saa_mte_gglaa_jj_mottmoozz_valmstoolli_taimmkadda.html"/>
