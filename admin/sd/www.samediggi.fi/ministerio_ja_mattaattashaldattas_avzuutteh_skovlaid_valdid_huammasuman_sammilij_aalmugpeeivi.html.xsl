...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/02/04/ministerio-ja-mattaattashaldattas-avzuutteh-skovlaid-valdid-huammasuman-sammilij-aalmugpeeivi/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Ministeriö já Máttááttâshaldâttâs avžuutteh škovlâid väldiđ huámmášumán sämmilij aalmugpeeivi - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="ministerio_ja_opetushallitus_suosittelevat_saamelaisten_kansallispaivan_huomioimista_opetuksessa.html"/>
        ...
        <parallel_text xml:lang="sme" location="ministeriija_ja_oahpahusraddehus_avzzuhit_skuvllaid_valdit_vuhtii_samiid_albmotbeaivvi.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="ministeria_da_matt_toshalltos_siazzta_lle_skooulid_vuo_tte_va_ldded_sa_mmlai_meersazpeei_v.html"/>
