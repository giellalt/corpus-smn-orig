...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2021/11/11/saminuorai-taaidatabahtusast-palhasum-video-mieldi-oskari-kistoost/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Säminuorâi taaiđâtábáhtusâst palhâšum video mieldi Oskari-kištoost - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaisnuorten_taidetapahtumassa_palkittu_video_mukana_oskari-kilpailussa.html"/>
        ...
        <parallel_text xml:lang="sme" location="samenuoraid_daiddadahpahusas_balkkasuvvon_video_mielde_oskari-gilvvus.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_mnuori_cea_ppvuottpeei_vest_ciist_vuazhzham_video_mie_ldd_oskari-keasttoottmoozzast.html"/>
