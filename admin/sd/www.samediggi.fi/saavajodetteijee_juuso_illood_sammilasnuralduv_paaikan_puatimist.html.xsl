...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2021/09/10/saavajodetteijee-juuso-illood-sammilasnuralduv-paaikan-puatimist/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Saavâjođetteijee Juuso illood sämmilâšnurâlduv pááikán puátimist - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="puheenjohtaja_juuso_iloitsee_saamelaiskokoelman_kotiinpaluusta.html"/>
        ...
        <parallel_text xml:lang="sme" location="sagajodiheaddji_juuso_illuda_samecoakkaldaga_ruoktotmahccamis.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saaggjaa_dteei_juuso_rammas_saa_mnorldoogg_ma_ccmest.html"/>
