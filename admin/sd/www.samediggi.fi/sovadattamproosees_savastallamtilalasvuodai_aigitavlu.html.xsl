...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2018/05/30/sovadattamproosees-savastallamtilalasvuodai-aigitavlu/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sovâdâttâmproosees savâstâllâmtilálâšvuođâi äigitavlu - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="sovintoprosessin_keskustelutilaisuuksien_aikataulu.html"/>
        ...
        <parallel_text xml:lang="sme" location="soabadanproseassa_sagastallandilalasvuodaid_aigetavval.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="suavadvuottprosee_ss_sagstoollampooddi_ai_ggtaull.html"/>
