...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2018/12/03/anaraskiela-puustavvideo-lii-valmastum/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Anarâškielâ  puustavvideo lii valmâštum - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="inarinsaamen_aakkosvideo_valmistui.html"/>
        ...
        <parallel_text xml:lang="sme" location="anarasgiela_bustavvavideo_valmmastuvai.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="alfabe_ttvideo_aanarsaa_mkio_lle_lij_vaalmas.html"/>
