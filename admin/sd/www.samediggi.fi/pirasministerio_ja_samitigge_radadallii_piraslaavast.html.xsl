...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2020/10/29/pirasministerio-ja-samitigge-radadallii-piraslaavast/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Pirâsministeriö já Sämitigge ráđádâllii pirâslaavâst - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="ministry_of_the_environment_and_sami_parliament_negotiate_on_the_climate_change_act.html"/>
        <parallel_text xml:lang="fin" location="ymparistoministerio_ja_saamelaiskarajat_kavivat_neuvotteluja_ilmastolaista.html"/>
        ...
        <parallel_text xml:lang="sme" location="birasministeriija_ja_samediggi_raddadalle_dalkkadatlagas.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="pirrosministeria_da_saa_mte_gg_sagsto_lle_aaimaslaa_jj_pirr.html"/>
