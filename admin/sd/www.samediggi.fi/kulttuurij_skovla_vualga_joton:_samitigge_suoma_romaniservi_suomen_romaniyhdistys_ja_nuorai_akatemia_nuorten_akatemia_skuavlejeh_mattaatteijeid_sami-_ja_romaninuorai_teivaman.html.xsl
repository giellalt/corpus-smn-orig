...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2021/08/23/kulttuurij-skovla-vualga-joton-samitigge-suoma-romaniservi-suomen-romaniyhdistys-ja-nuorai-akatemia-nuorten-akatemia-skuavlejeh-mattaatteijeid-sami-ja-romaninuorai-teivaman/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Kulttuurij škovlâ vuálgá joton: Sämitigge, Suomâ Romaniservi (Suomen Romaniyhdistys) já Nuorâi Akatemia (Nuorten Akatemia) škuávlejeh máttáátteijeid sämi- já romaninuorâi teivâmân - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="kulttuurien_koulu_kaynnistyy:_saamelaiskarajat_suomen_romaniyhdistys_ja_nuorten_akatemia_kouluttavat_opettajia_saamelais-_ja_romaninuorten_kohtaamiseen.html"/>
        ...
        <parallel_text xml:lang="sme" location="kultuvrraid_skuvla_alga:_samediggi_suoma_romanasearvi_ja_nuoraid_akademiija_skuvlejit_oahpaheaddjiid_same-_ja_romananuoraiguin_deaivvadeapmai.html"/>
