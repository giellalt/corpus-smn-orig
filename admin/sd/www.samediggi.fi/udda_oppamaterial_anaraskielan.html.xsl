...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2020/09/02/udda-oppamaterial-anaraskielan/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Uđđâ oppâmaterial anarâškielân - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="uutta_oppimateriaalia_inarinsaamenkieliseen_opetukseen.html"/>
        ...
        <parallel_text xml:lang="sme" location="odda_oahppamateriala_anarasgielat_oahpahussii.html"/>
