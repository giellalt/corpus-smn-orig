...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2022/02/09/valjalavdikode-callen-valjejum-antti-aikio/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Valjâlävdikode čällen väljejum Antti Aikio - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="vaalilautakunnan_sihteeriksi_valittu_antti_aikio.html"/>
        ...
        <parallel_text xml:lang="sme" location="valgalavdegotti_callin_lea_valljejuvvon_antti_aikio.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="vaal-lu_vddkaa_dd_piisren_va_lljum_antti_aikio.html"/>
