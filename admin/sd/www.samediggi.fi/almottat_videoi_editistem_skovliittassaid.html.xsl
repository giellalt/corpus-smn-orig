...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2021/03/31/almottat-videoi-editistem-skovliittassaid/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Almottât videoi editistem škovliittâssáid - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="ilmoittaudu_videoiden_editointi_koulutuksiin.html"/>
        ...
        <parallel_text xml:lang="sme" location="almmut_videoid_editerenskuvlejumiide.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saamelaisnuoi_lmmtood_videoi_edita_sttem_skooultoozzid.html"/>
