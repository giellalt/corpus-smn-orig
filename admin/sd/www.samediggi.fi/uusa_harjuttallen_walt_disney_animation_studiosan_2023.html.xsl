...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2022/12/16/uusa-harjuttallen-walt-disney-animation-studiosan-2023/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Uusâ hárjuttâllen Walt Disney Animation Studiosân 2023 - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="apply_as_an_internship_at_walt_disney_animation_studios_2023.html"/>
        ...
        <parallel_text xml:lang="sms" location="oozz_harjjtooll_jen_walt_disney_animation_studioid_2023.html"/>
