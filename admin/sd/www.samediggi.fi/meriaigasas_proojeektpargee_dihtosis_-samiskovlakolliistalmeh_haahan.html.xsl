...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2018/06/29/meriaigasas-proojeektpargee-dihtosis-samiskovlakolliistalmeh-haahan/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Meriáigásâš proojeektpargee Dihtosis -sämiškovlâkolliistâlmeh haahân - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="maaraaikainen_projektityontekija_dihtosis_-saamelaiskouluvierailut_hankkeelle.html"/>
        ...
        <parallel_text xml:lang="sme" location="mearreaigasas_proseaktabargi_dihtosis_-sameskuvlagalledeamit_prosektii.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="mie_rraiggsaz_proje_ktt-tuajjlaz_dihtosis-saa_mskooulko_ll_jummuz_ha_ngkko_sse.html"/>
