...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/toima/samikiela/kielapierval/mangii-koijadum-koccamusah/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Maŋgii koijâdum koččâmušah - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="usein_kysytyt_kysymykset.html"/>
        ...
        <parallel_text xml:lang="sme" location="davja_jerrojuvvon_gazaldagat.html"/>
