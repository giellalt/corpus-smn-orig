...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2021/01/21/dihtosis-toima-vijdan-vyeliskovlaid/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Dihtosis-toimâ vijđán vyeliškovláid - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="dihtosis-toiminta_laajenee_alakouluihin.html"/>
        ...
        <parallel_text xml:lang="sme" location="dihtosis-doaibma_viidana_vuolleskuvllaide.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="dihtosis-tuaimmjummus_veiddan_vue_llskooulid.html"/>
