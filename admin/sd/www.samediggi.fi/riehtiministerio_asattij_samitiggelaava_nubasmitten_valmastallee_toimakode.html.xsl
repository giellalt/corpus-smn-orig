...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2020/11/26/riehtiministerio-asattij-samitiggelaava-nubasmitten-valmastallee-toimakode/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Riehtiministeriö asâttij sämitiggelaavâ nubásmitten valmâštâllee toimâkode - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="oikeusministerio_asetti_saamelaiskarajalain_muutosta_valmistelevan_toimikunnan.html"/>
        ...
        <parallel_text xml:lang="sme" location="vuoigatvuodaministeriija_asahii_samediggelaga_nuppastusa_valmmastalli_doaibmagotti.html"/>
