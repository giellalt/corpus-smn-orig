...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2020/01/17/samitige-samikiela-toimattah-oca-nuorttalaskiela-jurgaleijee-sajasii/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sämitige sämikielâ toimâttâh ocá nuorttâlâškielâ jurgâleijee sajasii - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaiskarajien_saamen_kielen_toimisto_hakee_koltansaamen_kaantajan_sijaista.html"/>
        ...
        <parallel_text xml:lang="sms" location="saa_mtee_gg_saa_mkiol_koontar_aacc_nuorttsaa_mkiol_jaargloo_tti_sajjsa.html"/>
