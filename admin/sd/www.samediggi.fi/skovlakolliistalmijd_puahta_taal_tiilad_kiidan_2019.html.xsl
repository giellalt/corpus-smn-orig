...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/01/17/skovlakolliistalmijd-puahta-taal-tiilad-kiidan-2019/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Škovlâkolliistâlmijd puáhtá tääl tiiláđ kiiđân 2019 - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="kouluvierailut_ovat_nyt_tilattavissa_kevaalle_2019.html"/>
        ...
        <parallel_text xml:lang="sme" location="dal_sahtta_dinggot_skuvlagalledemiid_giddii_2019.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="skooulko_ll_jummuz_lie_aa_n_ti_ll_jemnalla_keadda_2019.html"/>
