...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2021/01/28/saami-aalmugpeivi-avuduvvoo-oovtast-virtuaallavt/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Säämi aalmugpeivi ávuduvvoo oovtâst virtuaallávt - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaisten_kansallispaivaa_vietetaan_yhdessa_virtuaalisesti.html"/>
        ...
        <parallel_text xml:lang="sme" location="sami_albmotbeaivi_avvuduvvo_ovttas_virtualalaccat.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_mi_meersazpeei_v_juu_hl_jet_ooutsaa_jest_virtuaal_lanji.html"/>
