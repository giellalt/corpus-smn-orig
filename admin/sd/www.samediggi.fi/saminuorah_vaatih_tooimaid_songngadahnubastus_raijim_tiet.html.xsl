...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2021/09/23/saminuorah-vaatih-tooimaid-sonnadahnubastus-raijim-tiet/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Säminuorah väätih tooimâid šoŋŋâdâhnubástus raijim tiet - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="sami_youth_demand_actions_to_mitigate_climate_change.html"/>
        <parallel_text xml:lang="fin" location="saamelaisnuoret_vaativat_toimia_ilmastonmuutoksen_hillitsemiseksi.html"/>
        ...
        <parallel_text xml:lang="sme" location="samenuorat_gaibidit_doaimmaid_dalkkadatrievdama_goahcamii.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_mnuor_oolgte_taaimaid_aimm-muttaz_tuo_lstoollmo_sse.html"/>
