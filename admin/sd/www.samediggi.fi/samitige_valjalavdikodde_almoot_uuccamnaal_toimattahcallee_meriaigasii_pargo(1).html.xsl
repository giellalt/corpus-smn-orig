...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2022/10/13/samitige-valjalavdikodde-almoot-uuccamnaal-toimattahcallee-meriaigasii-pargo/?lang=an'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaiskarajien_vaalilautakunta_ilmoittaa_haettavaksi_toimistosihteerin_maaraaikaisen_tehtavan(1).html"/>
        ...
        <parallel_text xml:lang="sme" location="samedikki_valgalavdegoddi_almmuha_ohcan_lahkai_doaimmahatcalli_mearreaigasas_barggu(1).html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_mtee_gg_vaal-lu_vddka_dd_i_lmmat_ooccamnalla_koontarpiisar_mie_rraiggsaz_tuaj(1).html"/>
