...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2021/05/26/spiekastahive-tovattem-vahagijd-puasuitualun-kalga-sajanmaksid/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Spiekâstâhive tovâttem vahâgijd puásuituálun kalga sajanmäksiđ - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="poikkeusvuoden_poronhoidolle_aiheuttamat_vahingot_tulee_korvata.html"/>
        ...
        <parallel_text xml:lang="sme" location="spiehkastatjagi_dagahan_vahagiid_boazodollui_galga_buhttet.html"/>
