...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/04/25/samitigge-uasalist-oa-algaaalmugij-pisovaa-fooruman-unpfii-new-yorkist/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sämitigge uásálist OA algâaalmugij pisováá foorumân (UNPFII) New Yorkist - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaiskarajat_osallistuu_yk:n_alkuperaiskansojen_pysyvaan_foorumiin_unpfii_new_yorkissa.html"/>
        ...
        <parallel_text xml:lang="sme" location="samediggi_oassalasta_on:id_eamialbmogiid_bissovas_forumii_unpfii_new_yorkas.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_mte_gg_vuassaatt_om:i_alggmeerai_poossi_fooruu_me_unpfii_new_yorkast.html"/>
