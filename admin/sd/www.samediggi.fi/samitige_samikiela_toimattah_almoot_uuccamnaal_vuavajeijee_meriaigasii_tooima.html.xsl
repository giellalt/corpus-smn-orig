...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/12/20/samitige-samikiela-toimattah-almoot-uuccamnaal-vuavajeijee-meriaigasii-tooima/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sämitige sämikielâ toimâttâh almoot uuccâmnáál vuávájeijee meriáigásii tooimâ - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaiskarajien_saamen_kielen_toimisto_ilmoittaa_haettavaksi_suunnittelijan_maaraaikaisen_tehtavan.html"/>
        ...
        <parallel_text xml:lang="sme" location="samedikki_samegiela_doaimmahat_almmuha_ohcan_lahkai_planejeaddji_mearreaigasas_doaimma.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_mtee_gg_saa_m_kiol_koontar_i_lmmat_ooccamnalla_plaaneei_mie_rraiggsaz_tuaj.html"/>
