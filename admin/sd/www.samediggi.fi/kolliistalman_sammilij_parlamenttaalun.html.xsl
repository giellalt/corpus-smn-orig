...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/ohtavuota/uapistum-kolliistalmeh/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Kolliistâlmân sämmilij parlamenttáálun - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="visiting_sami_parliament_house.html"/>
        <parallel_text xml:lang="fin" location="vierailulle_saamelaisten_parlamenttitaloon.html"/>
        ...
        <parallel_text xml:lang="sme" location="galledeapmi_samiid_parlameantadalus.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="ko_ll_jed_sa_mmlai_parlame_nttpo_rtte.html"/>
