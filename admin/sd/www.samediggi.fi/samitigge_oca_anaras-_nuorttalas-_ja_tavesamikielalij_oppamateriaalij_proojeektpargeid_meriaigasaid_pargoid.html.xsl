...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2022/01/18/samitigge-oca-anaras-nuorttalas-ja-tavesamikielalij-oppamateriaalij-proojeektpargeid-meriaigasaid-pargoid/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sämitigge ocá anarâš-, nuorttâlâš- já tavesämikielâlij oppâmateriaalij proojeektpargeid meriáigásáid pargoid - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaiskarajat_hakee_inarin-_koltan-_ja_pohjoissaamenkielisten_oppimateriaalien_projektityontekijoita_maaraaikaisiin_tehtaviin.html"/>
        ...
        <parallel_text xml:lang="sme" location="samediggi_ohca_anaras-_nuortalas-_ja_davvisamegielat_oahppamaterialaid_proseaktabargiid_mearreaigasas_doaimmaide.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_mte_gg_aacc_aanar-_nuortt-_ja_ta_vvsaa_mkiollsaz_mattmateriaali_proje_ktt-tuajjlaid_mie_rraiggsaz_tuajaid.html"/>
