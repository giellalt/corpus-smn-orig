...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2022/11/16/saami-parlamentaarlas-raadi-lii-huolastum-samitiggelaava-ovdanmist/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Säämi parlamentaarlâš rääđi lii huolâstum sämitiggelaavâ ovdánmist - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="the_sami_parliamentary_council_deeply_concerned_about_the_lack_of_progression_with_the_act_on_the_sami_parliament.html"/>
        <parallel_text xml:lang="fin" location="saamelainen_parlamentaarinen_neuvosto_on_huolissaan_saamelaiskarajalain_etenemisesta.html"/>
        ...
        <parallel_text xml:lang="sme" location="sami_parlamentaralas_raddi_lea_fuolas_samediggelaga_ovdaneamis.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_m_parlamentaarlaz_suavtos_lij_pe_ccloovvam_saa_mte_gglaa_jj_ouddnummsest.html"/>
