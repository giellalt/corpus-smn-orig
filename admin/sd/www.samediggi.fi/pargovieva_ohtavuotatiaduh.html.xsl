...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/ohtavuota-toimattuvah/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Pargovievâ ohtâvuotâtiäđuh - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="contact_information_of_the_personnel.html"/>
        <parallel_text xml:lang="fin" location="henkiloston_yhteystiedot.html"/>
        ...
        <parallel_text xml:lang="sme" location="bargiid_oktavuodadiedut.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="tuajjlai_ohttvuott-tead.html"/>
