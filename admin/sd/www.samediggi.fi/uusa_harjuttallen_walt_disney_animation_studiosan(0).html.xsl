...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/11/21/uusa-harjuttallen-walt-disney-animation-studiosan/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Uusâ hárjuttâllen Walt Disney Animation Studiosân - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="apply_as_an_intern_at_walt_disney_animation_studios(0).html"/>
        ...
        <parallel_text xml:lang="sme" location="oza_oahpahallin_walt_disney_animation_studios_.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="oozz_matt_toottjen_walt_disney_animation_studioid.html"/>
