...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2021/04/21/pyevtit-siskaldas-taaidatabahtus-sijdoid/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Pyevtit siskáldâs taaiđâtábáhtus sijđoid! - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="tuota_sisaltoa_taidetapahtuman_sivuille_.html"/>
        ...
        <parallel_text xml:lang="sme" location="rahkat_sisdoalu_daiddadahpahusa_siidduide_.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="tuejjad_siiskoozz_cea_ppvuodpeei_v_seeidaid_.html"/>
