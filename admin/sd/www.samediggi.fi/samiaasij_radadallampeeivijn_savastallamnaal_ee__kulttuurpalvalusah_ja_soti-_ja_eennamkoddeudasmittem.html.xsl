...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/11/07/samiaasij-radadallampeeivijn-savastallamnaal-ee-kulttuurpalvalusah-ja-soti-ja-eennamkoddeudasmittem/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sämiaašij ráđádâllâmpeeivijn savâstâllâmnáál ee. kulttuurpalvâlusah já soti- já eennâmkoddeuđâsmittem - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaisasioiden_neuvottelupaivilla_esilla_mm__kulttuuripalvelut_ja_sote-_ja_maakuntauudistus.html"/>
        ...
        <parallel_text xml:lang="sme" location="sode-_ja_eanangoddeodastus_sihke_kulturbalvalusat_ovdan_sameassiid_raddadallanbeivviin.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_maa_ssi_sagstoollampeei_vin_ou_dde_pu_httmest_odm__kulttuurkaazzkoozz_da_sote-_da_maddka_ddoodummus.html"/>
