...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2022/10/31/samikulttuurkuavdai-tooima-kalga-turvid/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sämikulttuurkuávdái tooimâ kalga turviđ - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaiskulttuurikeskusten_toiminta_taytyy_turvata.html"/>
        ...
        <parallel_text xml:lang="sme" location="samekulturguovddaziid_doaimma_galga_sihkkarastit.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_mkulttuurkooskoozzi_taimm_mos_fe_rttai_tuorvvad_.html"/>
