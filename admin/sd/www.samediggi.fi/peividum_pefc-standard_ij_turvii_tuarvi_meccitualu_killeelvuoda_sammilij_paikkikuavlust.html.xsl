...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2021/05/20/peividum-pefc-standard-ij-turvii-tuarvi-meccitualu-killeelvuoda-sammilij-paikkikuavlust/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Peividum PEFC-standard ij turvii tuárvi meccituálu killeelvuođâ sämmilij päikkikuávlust - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="paivitetty_pefc-standardi_ei_turvaa_riittavalla_tavalla_metsatalouden_kestavyytta_saamelaisten_kotiseutualueella.html"/>
        ...
        <parallel_text xml:lang="sme" location="beaivaduvvon_pefc-standarda_ii_sihkkarastte_doarvai_vuovdedoalu_suvdilvuoda_samiid_ruovttuguovllus.html"/>
