...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/11/04/saavajodetteijee-sanila-aikio-uasalist-frozen-2-maailmvuosaehidan/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Saavâjođetteijee Sanila-Aikio uásálist Frozen 2 maailmvuosâehidân - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="puheenjohtaja_sanila-aikio_osallistuu_frozen_2_maailmanensi-iltaan.html"/>
        ...
        <parallel_text xml:lang="sme" location="sagadoalli_sanila-aikio_oassalasta_frozen_2_mailmmivuosttaseahkedii.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saaggjaa_dteei_sanila-aikio_vuassaatt_frozen_2_maai_lmvuossjea_kki_zze.html"/>
