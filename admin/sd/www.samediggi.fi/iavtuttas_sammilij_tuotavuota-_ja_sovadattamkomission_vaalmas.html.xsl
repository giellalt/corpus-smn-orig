...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/11/14/iavtuttas-sammilij-tuotavuota-ja-sovadattamkomission-vaalmas/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Iävtuttâs sämmilij tuotâvuotâ- já sovâdâttâmkomission vaalmâš - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="ehdotus_saamelaisten_totuus-_ja_sovintokomissioksi_valmis.html"/>
        ...
        <parallel_text xml:lang="sme" location="evttohus_samiid_duohtavuohta-_ja_soabadankomisuvdnan_valmmas.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="e_tkkos_saa_mi_tuodasvuott-_da_suavadvuottkomission_vaalmas.html"/>
