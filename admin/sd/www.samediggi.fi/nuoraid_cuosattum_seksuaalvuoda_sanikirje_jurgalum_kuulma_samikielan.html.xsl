...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/10/29/nuoraid-cuosattum-seksuaalvuoda-sanikirje-jurgalum-kuulma-samikielan/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Nuoráid čuosâttum seksuaalvuođâ sänikirje jurgâlum kuulmâ sämikielân - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="nuorille_suunnattu_seksuaalisuuden_sanakirja_kaannetty_kolmelle_saamen_kielelle.html"/>
        ...
        <parallel_text xml:lang="sme" location="nuoraide_oaivvilduvvon_seksualavuoda_satnegirji_jorgaluvvon_golmma_samegillii.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="nuorid_rajjum_seksuaal_lazvuod_saa_nnke_rjj_jaarglottum_kou_mme_saa_mkio_lle.html"/>
