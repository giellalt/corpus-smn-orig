...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/08/29/riehtiminister-henriksson-ja-samitigge-teivii/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Riehtiminister Henriksson já Sämitigge teivii - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="oikeusministeri_henriksson_ja_saamelaiskarajat_tapasivat.html"/>
        ...
        <parallel_text xml:lang="sme" location="vuoigatvuodaministtar_henriksson_deaivvadii_samedikkiin.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="vuoiggadvuottminister_henriksson_da_saa_mte_gg_kaauno_tte.html"/>
