...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2022/04/12/saminuorai-taaidatabahtus-2022-uarnejuvvoo-cohcamaanust-anarist/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Säminuorâi taaiđâtábáhtus 2022 uárnejuvvoo čohčâmáánust Anarist – šlaaijân muusik já tiivtah - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaisnuorten_taidetapahtuma_2022_jarjestetaan_syyskuussa_inarissa_-_lajeina_musiikki_ja_runous.html"/>
        ...
        <parallel_text xml:lang="sme" location="samenuoraid_daiddadahpahus_2022_lagiduvvo_cakcamanus_anaris_-_sladjan_musihkka_ja_dikten.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_mnuori_cea_ppvuodpei_vv_2022_riazzat_cohccmannust_aanrest_-_slaajjan_musikk_da_tiivtas.html"/>
