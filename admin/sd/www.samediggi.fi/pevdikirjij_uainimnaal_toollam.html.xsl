...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/02/27/pevdikirjij-uainimnaal-toollam/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Pevdikirjij uáinimnáál toollâm - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="poytakirjojen_nahtavillapito.html"/>
        ...
        <parallel_text xml:lang="sme" location="beavdegirjjiid_oaidninlahkai_doallan.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="pa_rddkii_rji_vuei_nnemnalla_aannmos.html"/>
