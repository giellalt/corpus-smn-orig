...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/04/02/katja-gauriloff-anni-kristiina-juuso-ja-heli-huovinen-taaidatabahtus-tuamarin-tabahtus-ohjelm-almostui/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Katja Gauriloff, Anni-Kristiina Juuso já Heli Huovinen taaiđâtábáhtus tuámárin – tábáhtus ohjelm almostui - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="katja_gauriloff_anni-kristiina_juuso_ja_heli_huovinen_taidetapahtuman_tuomareiksi_-_tapahtuman_ohjelma_julkaistiin.html"/>
        ...
        <parallel_text xml:lang="sme" location="katja_gauriloff_anneristen_juuso_ja_heli_huovinen_daiddadahpahusa_duopmarin_-_dahpahusa_programma_almmustuvvon.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="katja_gauriloff_anni-kristiina_juuso_da_heli_huovinen_saa_mnuori_cea_ppvuodpeei_vi_arvstooll_jen_-_cea_ppvuodpeei_vi_programm_olmstottum.html"/>
