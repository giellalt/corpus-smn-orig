...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2018/05/30/nuorairaadi-ssn-ja-srk-pivdeh-saminuoraid-sovadattamproosees-savastallamtilalasvuotan-anaran-9-6/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Nuorâirääđi, SSN ja SRK pivdeh säminuorâid sovâdâttâmproosees savâstâllâmtilálâšvuotân Anarân 9.6. - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="nuorisoneuvosto_ssn_ja_vnk_kutsuvat_saamelaisnuoret_sovintoprosessin_keskustelutilaisuuteen_inariin_9_6_.html"/>
        ...
        <parallel_text xml:lang="sme" location="nuoraidraddi_ssn_ja_srk_bovdejit_samenuoraid_soabadankomisuvnna_sagastallandilalasvuhtii_anarii_9_6_.html"/>
