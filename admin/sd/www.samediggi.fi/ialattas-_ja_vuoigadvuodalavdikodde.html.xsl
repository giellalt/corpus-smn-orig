...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/lavdikodeh/ialattas-ja-vuoigadvuodalavdikodde/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Iäláttâs- já vuoigâdvuođâlävdikodde - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="livelihood_and_legal_committee.html"/>
        <parallel_text xml:lang="fin" location="elinkeino_ja_oikeus.html"/>
        ...
        <parallel_text xml:lang="sme" location="ealahus_ja_vuoigatvuohta.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="jie_llemvue_kk_da_vuoiggadvuott.html"/>
