...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/dihtosis-haaha/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Dihtosis-haahâ olášut škovlâkolliistâlmijd sämmilâšfáádá mield - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="dihtosis-hanke_toteuttaa_saamelaisaiheisia_kouluvierailuja.html"/>
        ...
        <parallel_text xml:lang="sme" location="dihtosis-proseakta_ollasuhtta_samefattat_skuvlagalledemiid.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="dihtosis-ha_ngkkos_ko_llai_skooulin_saa_mteemaivui_m.html"/>
