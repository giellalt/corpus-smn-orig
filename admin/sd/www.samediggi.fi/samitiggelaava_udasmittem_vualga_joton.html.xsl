...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2018/01/21/samitiggelaava-udasmittem-vualga-joton/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sämitiggelaavâ uđâsmittem vuálgá joton - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaiskarajalain_uudistaminen_kaynnistyy.html"/>
        ...
        <parallel_text xml:lang="sme" location="samediggelaga_odasmahttin_alggahuvvo.html"/>
