...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2020/06/09/sammilasparlamianttarij-konferens-2020-sirdasuva/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sämmilâšparlamiänttárij konferens 2020 sirdâšuvá  - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaisparlamentaarikkojen_konferenssi_2020_siirtyy.html"/>
        ...
        <parallel_text xml:lang="sme" location="sameparlamentarihkkariid_konferansa_2020_sirdasuvva_.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_mparlame_nttnii_kki_konfere_nss_2020_serddai_.html"/>
