...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2020/08/25/nuorttasamikiela-ja-tavesamikiela-digitaallas-sanikirjeh-laa-valmastum/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Nuorttâsämikielâ já tavesämikielâ digitaallâš sänikirjeh láá valmâštum - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="koltansaamen_ja_pohjoissaamen_digitaaliset_sanakirjat_valmistuneet.html"/>
        ...
        <parallel_text xml:lang="sme" location="nuortalasgiela_ja_davvisamegiela_digitala_satnegirjjit_valbmanan.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="nuorttsaa_m_da_ta_vvsaa_m_digitaal_laz_saa_nnkee_rj_valmstoovvam.html"/>
