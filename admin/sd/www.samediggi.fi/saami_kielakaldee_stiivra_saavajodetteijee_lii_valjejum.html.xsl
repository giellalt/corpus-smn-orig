...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2020/10/27/saami-kielakaldee-stiivra-saavajodetteijee-lii-valjejum/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Säämi Kielâkäldee stiivrâ saavâjođetteijee lii väljejum - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="sami_giellagaldun_hallituksen_puheenjohtaja_valittu.html"/>
        ...
        <parallel_text xml:lang="sms" location="saa_m_kiollka_lddi_halltoozz_saaggjaa_dteei_va_lljuum.html"/>
