...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2020/03/13/eennam-ja-meccitualuministerio-seelvatskuat-spiekastahlas-muotatile-vaikuttasaid-puasuitualun/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Eennâm- já meccituáluministeriö seelvâtškuát spiekâstâhlâš muotâtile vaikuttâsâid puásuituálun - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="maa-_ja_metsatalousministerio_selvittaa_poikkeuksellisten_lumiolosuhteiden_vaikutuksia_poronhoitoon.html"/>
        ...
        <parallel_text xml:lang="sme" location="eana-_ja_meahccedoalloministeriija_cielggada_spiehkastatmuohtadili_vaikkuhusaid_boazodollui.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="madd-_da_mea_cctaallministeria_ciolgad_a_lnn_aarrai_muottvue_jj_vaaiktoozzid_puazzhoiddu.html"/>
