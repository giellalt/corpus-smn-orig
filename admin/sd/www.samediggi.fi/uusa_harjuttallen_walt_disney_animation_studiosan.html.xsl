...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2020/12/21/uusa-harjuttallen-walt-disney-animation-studiosan-2/?lang=an'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="apply_as_an_intern_at_walt_disney_animation_studios.html"/>
        ...
        <parallel_text xml:lang="sms" location="oozz_harjjtooll_jen_walt_disney_animation_studioid.html"/>
