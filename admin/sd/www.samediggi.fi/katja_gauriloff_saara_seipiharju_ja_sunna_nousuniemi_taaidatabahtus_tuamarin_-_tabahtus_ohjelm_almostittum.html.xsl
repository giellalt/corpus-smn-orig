...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2021/05/14/katja-gauriloff-saara-seipiharju-ja-sunna-nousuniemi-taaidatabahtus-tuamarin-tabahtus-ohjelm-almostittum/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Katja Gauriloff, Sáárá Seipiharju já Sunna Nousuniemi taaiđâtábáhtus tuámárin – tábáhtus ohjelm almostittum - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="katja_gauriloff_saara_seipiharju_ja_sunna_nousuniemi_taidetapahtuman_tuomareiksi_-_tapahtuman_ohjelma_julkaistu.html"/>
        ...
        <parallel_text xml:lang="sme" location="katja_gauriloff_saara_seipiharju_ja_sunna_nousuniemi_daiddadahpahusa_duopmarin_-_dahpahusa_programma_almmustahtton.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="katja_gauriloff_saara_seipiharju_da_sunna_nousuniemi_cea_ppvuodpeei_v_su_vddjen_-_soddmoozz_programm_olmstottum.html"/>
