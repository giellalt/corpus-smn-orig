...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2021/06/10/neahttasatta-samediggelaga-nuppastusas-lea-geahccanlahkai/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Nettivuolgâttâs sämitiggelaavâ nubásmitmist lii keččâmnáál - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="verkkolahetys_saamelaiskarajalain_muutoksesta_on_katsottavissa.html"/>
        ...
        <parallel_text xml:lang="sme" location="neahttasatta_samediggelaga_nuppastusas_lea_geahccanlahkai.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="ne_ttvuolttos_saa_mte_gglaa_jj_muttsest_lij_kioccamnalla.html"/>
