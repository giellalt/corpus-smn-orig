...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/urbanbeaivvit-21-24-5-2018-anarist-povdiittas/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Urbánbeaivvit 21.–24.5.2018 Anarist - Povdiittâs - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="urbanbeaivvit_21_-24_5_2018.html"/>
        <parallel_text xml:lang="fin" location="urbanbeaivvit_21_-24_5_2018_inarissa_-_kutsu.html"/>
        ...
        <parallel_text xml:lang="sme" location="urbanbeaivvit_21_-24_5_2018_anaris_-_bovdehus.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="urbanbeaivvit_21_-24_5_2018_aanrest_-_kacc.html"/>
