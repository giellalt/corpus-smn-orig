...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2022/11/07/nuorttakielag-ucca-kirjij-raidu-almostui/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Nuorttâkielâg uccâ kirjij ráiđu almostui - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="sarja_koltansaamenkielisia_pienia_digikirjoja_ilmestyi.html"/>
        ...
        <parallel_text xml:lang="sme" location="nuortalasgielat_unna_digigirjjaziid_raidu_almmustahtton.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_mkiollsaz_u_cc_digikii_rji_raidd_i_lmstoovi.html"/>
