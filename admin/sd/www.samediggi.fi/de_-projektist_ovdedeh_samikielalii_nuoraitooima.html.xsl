...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/nuuham-haavah/de-projektist-ovdedeh-samikielalii-nuoraitooima/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'De!-projektist ovdedeh sämikielâlii nuorâitooimâ - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="de_-projektissa_kehitetaan_nuorisotoimintaa_saamen_kielilla.html"/>
        ...
        <parallel_text xml:lang="sme" location="de_-proseavttas_ovddidit_samegielat_nuoraiddoaimma.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="de_-projee_ktest_ooudasviiggat_nuorituaimmjummuz_saa_mkiolin.html"/>
