...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/08/01/ilmoittautuminen-auktorisoidun-kaantajan-tutkintoon-on-alkanut/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Almottâttâm auktoristum jurgâleijee totkosân lii álgám - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="ilmoittautuminen_auktorisoidun_kaantajan_tutkintoon_on_alkanut.html"/>
        ...
        <parallel_text xml:lang="sme" location="almmuheapmi_auktoriserejuvvon_jorgaleaddji_dutkosii_lea_algan.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="i_lmmtoottmos_auktorisosttum_jaarglo_tti_tu_tkko_sse_lij_alggam.html"/>
