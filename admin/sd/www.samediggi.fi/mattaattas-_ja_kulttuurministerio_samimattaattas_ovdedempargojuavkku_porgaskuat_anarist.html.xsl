...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2020/02/14/mattaattas-ja-kulttuurministerio-samimattaattas-ovdedempargojuavkku-porgaskuat-anarist/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Máttááttâs- já kulttuurministeriö sämimáttááttâs ovdedempargojuávkku porgâškuát Anarist - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="okm:n_saamelaisopetuksen_kehittamistyoryhma_aloittaa_tyonsa_inarissa.html"/>
        ...
        <parallel_text xml:lang="sme" location="okm:a_sameoahpahusa_ovddidanbargojoavku_alggaha_barggu_anaris.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="mkm_saa_m-matt_toozz_ooudasviikkama_rttel_alttad_tuajas_aanrest.html"/>
