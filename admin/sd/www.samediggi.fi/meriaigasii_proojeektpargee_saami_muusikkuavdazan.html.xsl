...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2018/04/18/meriaigasii-proojeektpargee-saami-muusikkuavdazan/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Meriáigásii proojeektpargee Säämi muusikkuávdážân - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="maaraaikainen_projektityontekija_saamelaismusiikkikeskukselle.html"/>
        ...
        <parallel_text xml:lang="sme" location="mearreaigasas_proseaktabargi_samemusihkkaguovddazii.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="mie_rraiggsa_proje_ktt-tuajjla_saa_m-musikk-koosko_sse.html"/>
