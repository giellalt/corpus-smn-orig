...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2018/01/28/tubetteijee-mansikkka-puata-skovlid-saminuoraid/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Tubetteijee Mansikkka puátá škovliđ säminuorâid - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="tubettaja_mansikkka_tulee_opastamaan_saamelaisnuoria.html"/>
        ...
        <parallel_text xml:lang="sme" location="tubbejeaddji_mansikkka_boahta_oahpistit_samenuoraid.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="tube_tteei_mansikkka_puatt_skooulted_saa_mnuorid.html"/>
