...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2020/01/28/mattaattas-ja-kulttuurministerio-miedettem-sieranastoorja-2020/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Máttááttâs- já kulttuurministeriö mieđettem sierânâstoorjâ 2020 - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="opetus-_ja_kulttuuriministerion_myontama_erityisavustus_2020.html"/>
        ...
        <parallel_text xml:lang="sme" location="oahpahus-_ja_kulturministeriija_miedihan_kulturmearrerudat_2020.html"/>
