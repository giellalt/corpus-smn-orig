...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2018/04/09/lah-uv-kiddiistum-ovdedid-samikielalii-nuoraipargo-puadi-walkers-rijjatatulazzan/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Lah-uv kiddiistum ovdediđ sämikielâlii nuorâipargo? Puáđi Walkers-rijjâtátulâžžân! - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="oletko_kiinnostunut_edistamaan_saamenkielista_nuorisotyota_tule_walkers-vapaaehtoiseksi_.html"/>
        ...
        <parallel_text xml:lang="sme" location="leatgo_berostuvvan_ovddidit_samegielat_nuoraidbarggu_boade_walkers-eaktodahtolas_bargin_.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="keass-a_tuu_mioll_ooudeed_saa_mkiollsaz_nuorituaj_pua_d_walkers-_tuojju_.html"/>
