...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/toima/samikiela/kielapierval/sammilij-kulttuur-ja-kielapiervaltoima-suomast/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sämmilij kulttuur- já kielâpiervâltoimâ Suomâst - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaisten_kulttuuri-_ja_kielipesatoiminta_suomessa.html"/>
        ...
        <parallel_text xml:lang="sme" location="samiid_kultur-_ja_giellabeassedoaibma_suomas.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="sa_mmlai_kulttuur-_da_kiollpie_sstuaimmjummus.html"/>
