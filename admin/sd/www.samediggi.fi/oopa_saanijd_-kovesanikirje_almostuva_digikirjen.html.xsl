...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2020/10/22/oopa-saanijd-kovesanikirje-almostuva-digikirjen/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Oopâ saanijd -kovesänikirje almostuvá digikirjen - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="oopa_saanijd_-kuvasanakirja_ilmestyy_digikirjana.html"/>
        ...
        <parallel_text xml:lang="sme" location="oopa_saanijd_-govvasatnegirji_almmustuvva_digigirjin.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="oopa_saanijd_-koovvsaa_nnke_rjj_i_lmstaavv_digike_rjjen.html"/>
