...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2021/01/08/samitigge-oca-meriaigasii-toimattahcallee-2/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sämitigge ocá meriáigásii toimâttâhčällee - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaiskarajat_hakee_maaraaikaista_toimistosihteeria(0).html"/>
        ...
        <parallel_text xml:lang="sme" location="samediggi_ohca_mearreaigasas_doaimmahatcalli(0).html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_mte_gg_aacc_mie_rraiggsaz_koontarpiisar(0).html"/>
