...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/09/19/saami-parlamentaarlii-raadi-saavajodettemvuota-sirdasuva-suoma-samitiigan/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Säämi parlamentaarlii rääđi saavâjođettemvuotâ sirdâšuvá Suomâ Sämitiigán - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaisen_parlamentaarisen_neuvoston_puheenjohtajuus_siirtyy_suomen_saamelaiskarajille_.html"/>
        ...
        <parallel_text xml:lang="sme" location="sami_parlamentaralas_radi_sagajodiheapmi_sirdasa_suoma_samediggai.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_m_parlamentaarlaz_suavtoozz_saaggjaa_dtummus_serddai_laa_ddjannam_saa_mtegga.html"/>
