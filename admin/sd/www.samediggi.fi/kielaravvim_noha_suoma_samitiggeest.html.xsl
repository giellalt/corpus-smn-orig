...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2022/12/15/kielaravvim-noha-suoma-samitiggeest/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Kielâravvim nohá Suomâ Sämitiggeest - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="kielineuvonta_paattyy_nykymuodossa_suomen_saamelaiskarajilla.html"/>
        ...
        <parallel_text xml:lang="sme" location="giellaravvenbargu_nohka_suoma_samedikkis_dala_hamis.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="kiollvuapstummus_poott_laa_dd_saa_mtee_ggest.html"/>
