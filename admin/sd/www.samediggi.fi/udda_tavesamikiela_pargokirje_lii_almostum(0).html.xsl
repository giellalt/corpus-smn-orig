...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2021/03/18/udda-tavesamikiela-pargokirje-lii-almostum/?lang=an'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="uusi_pohjoissaamen_kielen_tyokirja_ilmestynyt(0).html"/>
        ...
        <parallel_text xml:lang="sme" location="odda_bargogirji_davvisamegillii_almmuhuvvon(0).html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="odd_tuejjke_rjj_ta_vvsaamas_lij_i_lmstoovvam.html"/>
