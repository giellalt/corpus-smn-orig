...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2022/05/10/samiparlamianttarij-konferens-uarnejuvvoo-vyesimaanust-anarist/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sämiparlamiänttárij konferens uárnejuvvoo vyesimáánust Anarist - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="the_conference_of_sami_parliamentarians_will_be_held_in_inari_in_may.html"/>
        <parallel_text xml:lang="fin" location="saamelaisparlamentaarikkojen_konferenssi_jarjestetaan_toukokuussa_inarissa.html"/>
        ...
        <parallel_text xml:lang="sme" location="sameparlamentarihkkariid_konfereansa_lagiduvvo_miessemanus_anaris.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_mparlamentnii_kki_konfere_nss_ja_rjstet_vue_ssmannust_aanrest.html"/>
