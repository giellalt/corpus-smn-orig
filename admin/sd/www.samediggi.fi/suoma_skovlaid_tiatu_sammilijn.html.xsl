...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2018/08/29/suoma-skovlaid-tiatu-sammilijn/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Suomâ škovláid tiätu sämmilijn - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="suomen_kouluihin_tietoutta_saamelaisista.html"/>
        ...
        <parallel_text xml:lang="sme" location="suoma_skuvllaide_didolasvuohta_samiid_birra.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="laa_ddjannam_skooulid_teatt_sa_mmlai_pirr.html"/>
