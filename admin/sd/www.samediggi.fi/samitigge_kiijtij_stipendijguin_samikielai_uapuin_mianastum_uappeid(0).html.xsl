...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2022/06/06/samitigge-kiijtij-stipendijguin-samikielai-uapuin-mianastum-uappeid-2/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sämitigge kiijtij stipendijguin sämikielâi uápuin miänástum uáppeid - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaiskarajat_kiitti_stipendein_saamen_kielten_opinnoissa_menestyneita_oppilaita(0).html"/>
        ...
        <parallel_text xml:lang="sme" location="samediggi_giittii_stipeanddaiguin_samegielaid_oahpuin_bures_menestuvvan_oahppiid(0).html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_mte_gg_spa_ssboozzi_stipee_ndivui_m_saa_mkioli_maattain_puarast_pi_rggaam_matt_tootjid(0).html"/>
