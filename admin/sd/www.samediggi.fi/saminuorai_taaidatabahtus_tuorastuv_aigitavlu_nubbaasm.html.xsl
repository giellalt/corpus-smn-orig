...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2023/04/26/saminuorai-taaidatabahtus-tuorastuv-aigitavlu-nubbaasm/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Säminuorâi taaiđâtábáhtus tuorâstuv äigitavlu nubbáásm - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaisnuorten_taidetapahtuman_torstain_aikataulu_muuttuu.html"/>
        ...
        <parallel_text xml:lang="sme" location="samenuoraid_daiddadahpahusa_duorastaga_aigeplana_nuppastuvva.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_mnuori_cea_ppvuottpeei_v_neljdpeei_v_ai_ggtaull_mottai.html"/>
