...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2023/02/08/kiasut-uv-samitiggeest-porgam-tuu-vuolgat-avus-ucamus/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Kiäsut-uv Sämitiggeest porgâm tuu? Vuolgât ávus ucâmuš - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="oletko_kiinnostunut_tyoskentelemaan_saamelaiskarajilla_laheta_avoin_hakemus.html"/>
        ...
        <parallel_text xml:lang="sme" location="leatgo_berostuvvan_bargat_samedikkis_sadde_rabas_ohcamusa.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="leak-a_alssmam_reauggad_saa_mtee_ggest_vuolttad_aav_ooccmoozz.html"/>
