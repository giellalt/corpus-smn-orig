...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/lavdikodeh/ialattas-ja-vuoigadvuodalavdikodde/lahaaasatmist/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Lahâaasâtmist - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="legislation.html"/>
        <parallel_text xml:lang="fin" location="lainsaadanto.html"/>
        ...
        <parallel_text xml:lang="sme" location="lahkaasaheamis.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="laa_jjsiottoozzast.html"/>
