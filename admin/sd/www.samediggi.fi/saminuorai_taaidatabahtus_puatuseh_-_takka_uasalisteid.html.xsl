...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2022/09/16/saminuorai-taaidatabahtus-puatuseh-takka-uasalisteid/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Säminuorâi taaiđâtábáhtus puátuseh – takkâ uásálisteid - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaisnuorten_taidetapahtuman_tulokset_-_kiitos_osallistujille.html"/>
        ...
        <parallel_text xml:lang="sme" location="samenuoraid_daiddadahpahusa_bohtosat_-_giitosat_oassalastiide.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_mnuori_cea_ppvuottpeei_v_puadoozz_-_spa_sseb_vuassoottjid.html"/>
