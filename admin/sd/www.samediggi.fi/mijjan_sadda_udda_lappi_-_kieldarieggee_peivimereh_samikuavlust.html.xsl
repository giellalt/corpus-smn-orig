...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2018/05/22/mijjan-sadda-udda-lappi-kieldarieggee-peivimereh-samikuavlust/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Mijjân šadda uđđâ Lappi – Kieldârieggee peivimereh sämikuávlust - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="meille_syntyy_uusi_lappi_-_kuntakiertueen_paivamaarat_saamelaisalueella.html"/>
        ...
        <parallel_text xml:lang="sme" location="midjiide_sadda_odda_lappi_-_johtinplana_beaivemearit_sameguovllus.html"/>
