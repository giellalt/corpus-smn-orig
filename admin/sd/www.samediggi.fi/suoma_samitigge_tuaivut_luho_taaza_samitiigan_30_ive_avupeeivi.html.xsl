...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/09/25/suoma-samitigge-tuaivut-luho-taaza-samitiigan-30-ive-avupeeivi/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Suomâ Sämitigge tuáivut luho Taažâ Sämitiigán 30 ive ávupeeivi - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="suomen_saamelaiskarajat_toivottaa_onnea_norjan_saamelaiskarajille_30-vuotisjuhlapaivana.html"/>
        ...
        <parallel_text xml:lang="sme" location="suoma_samediggi_savva_lihku_norgga_samediggai_30_jagi_avvubeaivve.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="laa_ddjannam_saa_mte_gg_aajjast_leekk_kaimmses_30-ee_kkjuuhlast.html"/>
