...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2020/02/05/maht-valdid-huammasuman-sammilij-aalmugpeeivi/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Maht väldiđ huámmášumán sämmilij aalmugpeeivi? - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="miten_huomioida_saamelaisten_kansallispaiva_.html"/>
        ...
        <parallel_text xml:lang="sme" location="man_lahkai_vuhtii_valdit_samiid_albmotbeaivve_.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="ma_htt_va_ldded_lokku_saa_mi_meersazpei_vv_.html"/>
