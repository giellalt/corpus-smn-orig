...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/vaaljah-2023/valjaassikiirjij-siailuttem/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Valjâäššikiirjij siäiluttem - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="vaaliasiakirjojen_sailyttaminen.html"/>
        ...
        <parallel_text xml:lang="sme" location="valgaassegirjjiid_seailluheapmi.html"/>
