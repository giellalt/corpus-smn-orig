...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/10/21/samikielaliih-nuorai-tiatu-ja-ravvimsiijdoh-lekkaseh/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sämikielâliih nuorâi tiätu- já ravvimsiijđoh lekkâseh - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamenkielinen_nuorten_tieto-_ja_neuvontasivusto_avautuu.html"/>
        ...
        <parallel_text xml:lang="sme" location="nuoraid_samegielat_diehto-_ja_ravvensiiddut_rahpasit.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_mkiollsaz_nuori_teatt-_da_vua_pstos-seiddos_avvan.html"/>
