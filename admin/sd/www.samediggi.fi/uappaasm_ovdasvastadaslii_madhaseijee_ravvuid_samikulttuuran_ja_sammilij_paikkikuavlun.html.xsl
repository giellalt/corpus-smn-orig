...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2022/05/16/uappaasm-ovdasvastadaslii-madhaseijee-ravvuid-samikulttuuran-ja-sammilij-paikkikuavlun/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Uáppáásm ovdâsvástádâslii mađhâšeijee ravvuid sämikulttuurân já sämmilij päikkikuávlun - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="discover_responsible_visitor_s_guidance_to_sami_culture_and_sami_homeland_in_finland.html"/>
        <parallel_text xml:lang="fin" location="tutustu_vastuullisen_matkailijan_ohjeistukseen_saamelaiskulttuuriin_ja_saamelaisten_kotiseutualueelle.html"/>
        ...
        <parallel_text xml:lang="sme" location="oahpasmuva_vasttolas_turistta_ravvagiidda_guoskkadin_samekultuvrra_ja_samiid_ruovttuguovllu.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="tobdstood_vasttoozzlaz_turiist_ra_vvjo_sse_saa_mkulttuu_re_da_saa_mi_dommvoudda.html"/>
