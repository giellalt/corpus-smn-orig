...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/06/01/samitigge-juovij-stipendijd-nuorttalaskiela-pajeuappeeiskosist-eenab-calleeh-ko-kuassin-ovdil/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sämitigge juovij stipendijd – nuorttâlâškielâ pajeuáppeeiskosist eenâb čälleeh ko kuássin ovdil - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaiskarajat_jakoi_stipendeja_-_koltansaamen_ylioppilaskokeen_kirjoittaneita_ennatysmaara.html"/>
        ...
        <parallel_text xml:lang="sme" location="samediggi_jugii_stipeanddaid_-_nuortalasgiela_studeantaiskosa_callit_eanet_go_goassige_ovdal.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_mte_gg_jue_jji_stipee_ndid_-_nuorttsaa_mkiol_pa_jjmatt_toottitee_st_kee_rjteei_lia_samai_maanggas.html"/>
