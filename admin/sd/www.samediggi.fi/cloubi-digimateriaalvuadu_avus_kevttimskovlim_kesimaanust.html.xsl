...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2021/06/03/cloubi-digimateriaalvuadu-avus-kevttimskovlim-kesimaanust/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Cloubi-digimateriaalvuáđu ávus kevttimškovlim kesimáánust - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="cloubi-digimateriaalialustan_avoin_kayttokoulutus_kesakuussa.html"/>
        ...
        <parallel_text xml:lang="sme" location="cloubi-digimaterialavuodu_rabas_geavaheaddjiskuvlejupmi_geassemanus.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="cloubi-digimateriaalvuad_aa_v_aa_nnemskooultos_kie_ssmannust.html"/>
