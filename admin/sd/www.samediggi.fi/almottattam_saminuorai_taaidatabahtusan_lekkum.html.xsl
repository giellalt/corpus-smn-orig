...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2021/04/07/almottattam-saminuorai-taaidatabahtusan-lekkum/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Almottâttâm Säminuorâi taaiđâtábáhtusân lekkum - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="ilmoittautuminen_saamelaisnuorten_taidetapahtumaan_avattu.html"/>
        ...
        <parallel_text xml:lang="sme" location="almmuheapmi_samenuoraid_daiddadahpahussii_lea_rahppojuvvon.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="i_lmmtoottmos_saa_mnuori_cea_ppvuodpeivva_aa_vuum.html"/>
