...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2018/03/23/kielakaldee-giellagaldu-proojekt-loppaseminaar-anarist-4-4-2018/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Kielâkäldee (Giellagáldu) -proojekt loppâseminaar Anarist 4.4.2018 - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="giellagaldu-projektin_paatosseminaari_inarissa_4_4_2018.html"/>
        ...
        <parallel_text xml:lang="sme" location="giellagaldu-proseavtta_loahppaseminara_anaris_4_4_2018.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="kiollka_lddi-projee_kt_kiorgtemseminaar_aanrest_4_4_2018.html"/>
