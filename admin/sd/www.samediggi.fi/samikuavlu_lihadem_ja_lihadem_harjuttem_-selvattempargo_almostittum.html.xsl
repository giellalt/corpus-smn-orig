...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2020/10/01/samikuavlu-lihadem-ja-lihadem-harjuttem-selvattempargo-almostittum/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sämikuávlu lihâdem já lihâdem hárjuttem -selvâttempargo almostittum - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaisalueen_liikunta_ja_liikunnan_harrastaminen_-selvitystyo_julkaistu.html"/>
        ...
        <parallel_text xml:lang="sme" location="sameguovllu_lihkadeapmi_ja_lihkadeami_harjeheapmi_-cielggadanbargu_almmustahttojuvvon.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_mvuu_d_liikkummus_da_spoort_staarjoottmos_-cio_lggostuajj_olmstottum.html"/>
