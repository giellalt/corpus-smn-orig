...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2018/11/14/avus-tilalasvuota-sammilii-kirjalasvuoda-tiileest/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Ávus tilálâšvuotâ sämmilii kirjálâšvuođâ tiileest - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="avoin_tilaisuus_saamelaiskirjallisuuden_tilasta.html"/>
        ...
        <parallel_text xml:lang="sme" location="rabas_dilalasvuohta_samegirjjalasvuoda_dilis.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="aavai_podd_saa_mkeerjlazvuod_vue_jjest.html"/>
