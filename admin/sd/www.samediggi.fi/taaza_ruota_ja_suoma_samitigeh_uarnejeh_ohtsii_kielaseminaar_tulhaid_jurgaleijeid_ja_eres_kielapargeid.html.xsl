...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/06/27/taaza-ruota-ja-suoma-samitigeh-uarnejeh-ohtsii-kielaseminaar-tulhaid-jurgaleijeid-ja-eres-kielapargeid/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Taažâ, Ruotâ já Suomâ sämitigeh uárnejeh ohtsii kielâseminaar tulháid, jurgâleijeid já eres kielâpargeid - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="sami_parliaments_of_norway_sweden_and_finland_arrange_a_joint_language_seminar_for_interpreters_translators_and_other_language_workers.html"/>
        <parallel_text xml:lang="fin" location="norjan_ruotsin_ja_suomen_saamelaiskarajat_jarjestavat_yhteisen_kieliseminaarin_tulkeille_kaantajille_ja_muille_kielityontekijoille.html"/>
        ...
        <parallel_text xml:lang="sme" location="norgga_ruota_ja_suoma_samedikkit_lagidit_oktasas_giellaseminara_dulkkaide_jorgaleddjiide_ja_eara_giellabargiide.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="taarrjannam_ruoccjannam_da_laa_ddjannam_saa_mtee_gg_rea_sse_ohttsaz_kiollseminaar_tuulkid_jaarglo_ttjid_da_jee_res_kiolltuajjlaid.html"/>
