...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2018/06/29/meriaigasas-proojeektpargee-de-samikielalii-nuoraikulttuur-karttim-ja-ovdedem-haahan/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Meriáigásâš proojeektpargee De! -Sämikielâlii nuorâikulttuur karttim já ovdedem haahân - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="maaraaikainen_projektityontekija_de_-saamenkielisen_nuorisokulttuurin_kartoitus_ja_kehittaminen_hankkeelle.html"/>
        ...
        <parallel_text xml:lang="sme" location="mearreaigasas_proseaktabargi_de_-samegielat_nuoraidkultuvrra_karten_ja_ovddideapmi_prosektii.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="mie_rraiggsaz_proje_ktt-tuajjalz_de_-saa_mkiollsaz_nuorikulttuur_kaart_tummus_da_ooudummus_ha_ngkko_sse.html"/>
