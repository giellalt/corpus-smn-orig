...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2018/06/15/oulu-ollaopattahan-ruttadem-samikielalij-amnasmattaatteijei-skovlimhaava-varas/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Oulu ollâopâttâh finnejii ruttâdem sämikielâlij amnâsmáttáátteijei škovlimhaavâ várás - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="oulun_yliopisto_sai_rahoituksen_saamenkielisten_aineenopettajien_koulutushankkeelle.html"/>
        ...
        <parallel_text xml:lang="sme" location="oulu_universitehta_oaccui_ruhtadeami_samegielat_avnnasoahpaheddjiid_skuvlenprosektii.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="oulu_universitetta_teaggtos_saa_mkiollsaz_aaunasu_ctee_li_skooultosha_ngkko_sse.html"/>
