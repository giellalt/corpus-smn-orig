...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/09/26/udda-oppamateriaalsiijdoh-ja-nettikavppi-lekkasii/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Uđđâ oppâmateriaalsiijđoh já nettikävppi lekkâsii - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="uudet_oppimateriaalisivut_ja_verkkokauppa_avautuivat.html"/>
        ...
        <parallel_text xml:lang="sme" location="odda_oahppamaterialasiiddut_ja_neahttagavpi_rahpasedje.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="odd_mattmateriaalseeid_da_ne_ttkaupp_avvne.html"/>
