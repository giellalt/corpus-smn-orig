...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2022/11/10/mij-oovtast-viarmadah-juatka-pargos-skammamaanust/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Mij oovtâst -viärmádâh juátká pargos skammâmáánust - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="mii_ovttas_-verkosto_jatkaa_tyotaan_marraskuussa.html"/>
        ...
        <parallel_text xml:lang="sme" location="mii_ovttas_-fierpmadat_joatka_barggus_skabmamanus.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="mii_ovttas_saaimas_juatkk_tuajas_skamm-mannust.html"/>
