...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/toima/skovlim-ja-oppamateriaal/skovlim-ja-oppamateriaaltoimattah/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Škovlim- já oppâmateriaaltoimâttâh - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="koulutus-_ja_oppimateriaalitoimisto.html"/>
        ...
        <parallel_text xml:lang="sme" location="skuvlen-_ja_oahppamaterialadoaimmahat.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="skooultos-_da_mattmateriaalkoontar.html"/>
