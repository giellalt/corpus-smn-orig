...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/samimattaattas-ja-oppamateriaalpargo/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sämimáttááttâs já oppâmateriaalpargo - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="education.html"/>
        <parallel_text xml:lang="fin" location="saamelaisopetus_ja_oppimateriaalityo.html"/>
        ...
        <parallel_text xml:lang="sme" location="skuvlen_ja_samegielat_oahppamaterialabargu.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_m-matt_tos_da_mattmateriaaltuajj.html"/>
