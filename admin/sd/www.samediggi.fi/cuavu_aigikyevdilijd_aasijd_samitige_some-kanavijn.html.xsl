...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2018/04/12/cuavu-aigikyevdilijd-aasijd-samitige-some-kanavijn/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Čuávu äigikyevdilijd aašijd Sämitige some-kanavijn - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="seuraa_ajankohtaisia_asioita_saamelaiskarajien_some-kanavilla.html"/>
        ...
        <parallel_text xml:lang="sme" location="cuovo_aigeguovdilis_assiid_samedikki_some-kanalain.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="seu_rre_aai_jpoddsaz_aa_ssid_saa_mtee_gg_some-kanaalin.html"/>
