...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/09/26/ahr-kho-puastumiaradasain-oppeet-udda-kuoddalem/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'AHR (KHO) puástumiärádâsâin oppeet uđđâ kuoddâlem - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="kho:n_virheellisista_paatoksista_jalleen_uusi_kantelu.html"/>
        ...
        <parallel_text xml:lang="sme" location="ahr_feaillalas_mearradusain_fas_odda_guoddaleapmi.html"/>
