...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2018/09/03/skovlimpovdiittas-saminuoraid-olmoosvuoigadvuodain/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Škovlimpovdiittâs säminuoráid olmoošvuoigâdvuođâin - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="koulutuskutsu_saamelaisnuorille_ihmisoikeuksista.html"/>
        ...
        <parallel_text xml:lang="sme" location="skuvlenbovdehus_samenuoraide_olmmosvuoigatvuodaid_birra.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="skooultoskacc_saa_mnuorid_ooumazvuoiggadvuodi_pirr.html"/>
