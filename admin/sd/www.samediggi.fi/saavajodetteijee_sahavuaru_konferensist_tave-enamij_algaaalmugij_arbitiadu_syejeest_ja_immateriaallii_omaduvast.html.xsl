...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2021/11/11/saavajodetteijee-sahavuaru-konferensist-tave-enamij-algaaalmugij-arbitiadu-syejeest-ja-immateriaallii-omaduvast/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Saavâjođetteijee sahâvuáru konferensist Tave-enâmij algâaalmugij ärbitiäđu syejeest já immateriaallii omâduvâst - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="puheenjohtajan_puheenvuoro_konferenssissa_pohjoismaiden_alkuperaiskansojen_perinteisen_tiedon_suojasta_ja_aineettomasta_omaisuudesta.html"/>
        ...
        <parallel_text xml:lang="sme" location="sagadoalli_sahkavuorru_konferanssas_davviriikkaid_eamialbmogiid_arbevirolas_diedu_suojis_ja_immateriala_opmodagas.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saaggjaa_dteei_saakkvuarr_konferee_nsest_ta_vvjannmi_alggmeerai_a_rbbvuodlaz_tead_suojast_da_aaunaste_mes_jallmoozzast.html"/>
