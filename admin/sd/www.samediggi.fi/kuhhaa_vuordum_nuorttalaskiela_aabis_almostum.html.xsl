...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2021/12/14/kuhhaa-vuordum-nuorttalaskiela-aabis-almostum/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Kuhháá vuordum nuorttâlâškielâ aabis almostum - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="kauan_odotettu_koltansaamen_aapinen_ilmestynyt.html"/>
        ...
        <parallel_text xml:lang="sme" location="guhka_vurdojuvvon_nuortalasgiela_appes_almmustuvvan.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="kuu_kk_vuorddum_saa_mkiol_aabbas_i_lmstoovvam.html"/>
