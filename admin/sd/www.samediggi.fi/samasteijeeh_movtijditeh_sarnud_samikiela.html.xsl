...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/samasteijeeh-movtijditeh-sarnud-samikiela/?lang=an'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamen_kielten_kielilahettilaat_innostavat_puhumaan_saamea.html"/>
        ...
        <parallel_text xml:lang="sme" location="sami_giellaofelaccat_movttiidahttet_samastit.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_mkiol_saa_msteei_alsma_tte_mainsted_saa_mkiol.html"/>
