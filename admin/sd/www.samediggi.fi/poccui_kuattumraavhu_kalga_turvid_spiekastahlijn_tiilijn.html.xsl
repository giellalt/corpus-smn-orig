...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2020/04/02/poccui-kuattumraavhu-kalga-turvid-spiekastahlijn-tiilijn/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Poccui kuáttumráávhu kalga turviđ spiekâstâhlijn tiilijn - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="porojen_laidunrauha_turvattava_poikkeuksellisissa_olosuhteissa.html"/>
        ...
        <parallel_text xml:lang="sme" location="bohccuid_guohtunrafi_galga_dorvvastit_spiehkastat_diliin.html"/>
