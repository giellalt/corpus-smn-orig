...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2018/05/17/jottee-nuorai-teivademsaje-puata-cohcuv-sammilij-paikkikuavlun/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Jottee nuorâi teivâdemsaje puátá čohčuv sämmilij päikkikuávlun - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="liikkuva_nuorten_kohtaamispaikka_syksyksi_saamelaisten_kotiseutualueelle.html"/>
        ...
        <parallel_text xml:lang="sme" location="johtti_nuoraidlatnja_cakcat_samiid_ruovttuguvlui.html"/>
