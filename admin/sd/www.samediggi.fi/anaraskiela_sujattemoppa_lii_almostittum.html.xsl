...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2022/08/16/anaraskiela-sujattemoppa-lii-almostittum/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Anarâškielâ sujâttemoppâ lii almostittum - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="inarinsaamen_taivutusoppi_on_julkaistu.html"/>
        ...
        <parallel_text xml:lang="sme" location="inarisaamen_taivutusoppi_lea_almmuhuvvon.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="aanroskiol_soojtem-matt_ke_rjj_lij_i_lmstoovvam.html"/>
