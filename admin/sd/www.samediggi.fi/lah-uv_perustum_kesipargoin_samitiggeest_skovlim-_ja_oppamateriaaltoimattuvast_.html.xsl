...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2018/01/28/lah-uv-perustum-kesipargoin-samitiggeest-skovlim-ja-oppamateriaaltoimattuvast/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Lah-uv perustum kesipargoin Sämitiggeest škovlim- já oppâmateriaaltoimâttuvâst? - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="oletko_kiinnostunut_kesatyosta_saamelaiskarajien_koulutus-_ja_oppimateriaalitoimistossa_.html"/>
        ...
        <parallel_text xml:lang="sms" location="leak-a_perste_mmen_kie_sstuejast_saa_mtee_ggest_skooultos-_da_mattmateriaalkonttrest_.html"/>
