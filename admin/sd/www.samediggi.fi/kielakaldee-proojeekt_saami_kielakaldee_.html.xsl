...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/nuuham-haavah/kielakaldee-proojeekt-saami-kielakaldee/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Kielâkäldee-proojeekt (Säämi Kielâkäldee) - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="giellagaldu-hanke_sami_giellagaldu_.html"/>
        ...
        <parallel_text xml:lang="sme" location="giellagaldu-proseakta_ja_sami_giellagaldu.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="kiollka_lddi-ha_ngkkos_da_saa_m_kiollka_lddi.html"/>
