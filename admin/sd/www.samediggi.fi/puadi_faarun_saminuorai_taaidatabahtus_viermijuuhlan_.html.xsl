...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2020/04/16/puadi-faarun-saminuorai-taaidatabahtus-viermijuuhlan/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Puáđi fáárun Säminuorâi taaiđâtábáhtus viermijuuhlán! - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="tule_mukaan_saamelaisnuorten_taidetapahtuman_verkkojuhlaan_.html"/>
        ...
        <parallel_text xml:lang="sme" location="boade_mielde_samenuoraid_daiddadahpahusa_neahttadoaluide_.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="pua_d_mie_ldd_saa_mnuori_cea_ppvuottpeei_v_ne_ttju_hlle_.html"/>
