...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2022/10/20/anaraskiela-lievlai-siste-nuorttalaskiela-kamarist-ja-tavesamikiela-paadi-piallast-avus-oppatiijmeh-samikielai-ohhoost/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Anarâškielâ lievlâi siste, nuorttâlâškielâ kámárist já tavesämikielâ pääđi piällást – ávus oppâtiijmeh sämikielâi ohhoost! - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="inarinsaamea_loylyissa_koltansaamea_kammarissa_ja_pohjoissaamea_padan_aaressa_-_avoimet_oppitunnit_saamen_kielten_viikolla_.html"/>
        ...
        <parallel_text xml:lang="sme" location="anarasgiella_lievllaid_siste_nuortalasgiella_gammaris_ja_davvisamegiella_badi_guoras_-_rabas_oahppodiimmut_sami_giellavahku_.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="aanarsaa_mm_saaunoottmen_nuorttsaa_mm_kammrest_da_ta_vvsaa_mm_kruait_paaldast-_aavmattciass_saa_mkioli_nea_ttlest_43_.html"/>
