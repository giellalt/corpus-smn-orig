...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2023/05/30/who-tuhhiittij-julgastas-algaaalmugij-tiervasvuodast-samitigge-uasalistij-julgastas-valmastalman/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'WHO tuhhiittij julgáštâs algâaalmugij tiervâsvuođâst – Sämitigge uásálistij julgáštâs valmâštâlmân - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="the_who_has_approved_a_resolution_on_the_health_of_indigenous_peoples_-_the_sami_parliament_participated_in_the_preparation_of_the_resolution.html"/>
        <parallel_text xml:lang="fin" location="who_hyvaksyi_julkilausuman_alkuperaiskansojen_terveydesta_-_saamelaiskarajat_osallistui_julkilausuman_valmisteluun.html"/>
        ...
        <parallel_text xml:lang="sme" location="who_dohkkehii_loahppaarvalusa_eamialbmogiid_dearvvasvuodas_-_samediggi_oassalasttii_loahppaarvalusa_valmmastallamii.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="who_priimi_oolmascealkkmoozz_alggmeerai_tiorvasvuodast_-_saa_mte_gg_vuassoodi_oolmascealkkmoozz_valmstoollmo_sse.html"/>
