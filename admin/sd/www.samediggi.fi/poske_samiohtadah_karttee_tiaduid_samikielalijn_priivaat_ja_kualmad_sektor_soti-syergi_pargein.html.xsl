...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2021/07/20/posken-saamelaisyksikko-kartoittaa-saamenkielisia-yksityisia-ja-kolmannen-sektorin-sote-alan-tyontekijoita/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Poske sämiohtâdâh kärttee tiäđuid sämikielâlijn priivaat já kuálmád sektor soti-syergi pargein - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="posken_saamelaisyksikko_kartoittaa_saamenkielisia_yksityisen_ja_kolmannen_sektorin_sote-alan_tyontekijoita.html"/>
        ...
        <parallel_text xml:lang="sme" location="poske_sameossodat_karte_dieduid_samegielat_privahta_ja_goalmmat_sektora_sode-suorggi_bargiiguin.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="poske_saa_mjuaggas_karttad_teadaid_saa_mkiollsain_poorgas-_da_kualmad_sektoor_sosiaal-_ja_tiorvasvuottsue_rj_tuajjtuejjee_jin.html"/>
