...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/tiaduh-koronavirusist-samikielan/?lang=an'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="tietoa_koronaviruksesta_saamen_kielilla(0).html"/>
        ...
        <parallel_text xml:lang="sme" location="diehtu_koronavirusa_birra_samegillii(0).html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="tead_koronaviruuzz_pirr_saa_mkio_lle(0).html"/>
