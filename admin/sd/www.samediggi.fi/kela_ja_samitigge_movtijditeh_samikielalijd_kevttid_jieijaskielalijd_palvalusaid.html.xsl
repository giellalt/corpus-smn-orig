...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2023/05/04/kela-ja-samitigge-movtijditeh-samikielalijd-kevttid-jieijaskielalijd-palvalusaid/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Kela já Sämitigge movtijditeh sämikielâlijd kevttiđ jieijâskielâlijd palvâlusâid - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="kela_ja_saamelaiskarajat_kannustavat_saamenkielisia_kayttamaan_omakielisia_palveluja.html"/>
        ...
        <parallel_text xml:lang="sme" location="kela_ja_samediggi_movttiidahttet_samegielagiid_geavahit_iezaset_gielat_balvalusaid.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="kela_da_saa_mte_gg_sme_llka_tte_saa_mkiollsaid_aa_nned_jiijjaskiollsaid_kaazzkoozzid.html"/>
