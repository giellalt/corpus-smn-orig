...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/saami-parlamentaarlas-raadi/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Säämi parlamentaarlâš rääđi - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="sami_parliamentary_council.html"/>
        <parallel_text xml:lang="fin" location="saamelainen_parlamentaarinen_neuvosto.html"/>
        ...
        <parallel_text xml:lang="sme" location="sami_parlamentaralas_raddi.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_m_parlamenttaarlaz_suavtos.html"/>
