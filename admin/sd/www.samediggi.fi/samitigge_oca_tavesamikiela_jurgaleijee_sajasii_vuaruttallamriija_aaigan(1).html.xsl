...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2022/04/29/samitigge-oca-tavesamikiela-jurgaleijee-sajasii-vuaruttallamriija-aaigan/?lang=an'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaiskarajat_hakee_pohjoissaamen_kaantajan_sijaista_vuorotteluvapaan_ajaksi(1).html"/>
        ...
        <parallel_text xml:lang="sme" location="samediggi_ohca_jorgaleaddji_sadjasacca_vurohallanfriija_aigai(1).html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_mte_gg_aacc_jaarglo_tti_sajjsa_vuartoollamluovasvuod_aaigas(1).html"/>
