...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/09/12/dihtosis-haaha-vigga-lasettid-nuorai-tiaduid-sammilijn/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Dihtosis-haahâ viggá lasettiđ nuorâi tiäđuid sämmilijn - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="dihtosis-hanke_pyrkii_lisaamaan_nuorten_saamelaistietoisuutta.html"/>
        ...
        <parallel_text xml:lang="sme" location="dihtosis_-_proseakta_geahccala_lasihit_nuoraid_samedidolasvuoda.html"/>
