...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2022/05/23/tiatu-taidu-ja-utke-spella-lii-taal-almostum-meid-nuortta-ja-tavesamikielan/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'TIÄTU, TÁIĐU JÁ UTKE -spellâ lii tääl almostum meid nuorttâ- já tavesämikielân - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="tieto_taito_temppu_-peli_on_nyt_ilmestynyt_myos_koltan-_ja_pohjoissaamenkielille.html"/>
        ...
        <parallel_text xml:lang="sme" location="diehtu_daidu_goansta_-speallu_lea_dal_almmuhuvvon_maiddai_nuortalas-_ja_davvisamegielaide.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="teatt_taidd_tempp_-speall_lij_aa_n_olmstottum_se_nuortt_-da_ta_vvsaamas.html"/>
