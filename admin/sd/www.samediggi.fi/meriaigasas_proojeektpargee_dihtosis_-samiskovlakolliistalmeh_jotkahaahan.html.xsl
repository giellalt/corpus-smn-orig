...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/06/13/meriaigasas-proojeektpargee-dihtosis-samiskovlakolliistalmeh-jotkahaahan/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Meriáigásâš proojeektpargee Dihtosis -sämiškovlâkolliistâlmeh jotkâhaahân - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="maaraaikainen_projektityontekija_dihtosis_-saamelaiskouluvierailut_jatkohankkeelle.html"/>
        ...
        <parallel_text xml:lang="sme" location="mearreaigasas_proseaktabargi_dihtosis-sameskuvlagalledeamit_joatkkaprosektii.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="mie_rraiggsaz_proje_ktt-tuajjlaz_dihtosis_-saa_mskooulko_ll_jummuz_juatkkha_ngkko_sse.html"/>
