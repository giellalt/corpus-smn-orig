...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2021/11/17/juuso-ja-koivisto-uasalistev-ruavinjaarga-arctic-spirit-konferensan/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Juuso já Koivisto uásálistev Ruávinjaargâ Arctic Spirit konferensân - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="juuso_ja_koivisto_osallistuvat_rovaniemi_arctic_spirit_konferenssiin.html"/>
        ...
        <parallel_text xml:lang="sme" location="juuso_ja_koivisto_oassalastiba_roavvenjargga_arctic_spirit_konferansii.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="juuso_da_koivisto_vuassa_tte_rua_vnjargg_arctic_spirit_konferenssa.html"/>
