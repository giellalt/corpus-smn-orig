...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2020/06/10/samimuusik-konserteh-stream-vuolgattassan-sajosist/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sämimuusik konserteh stream-vuolgâttâssân Sajosist - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaismusiikin_konsertteja_suoratoistona_sajoksesta.html"/>
        ...
        <parallel_text xml:lang="sme" location="samemusihka_konsearttat_njuolggosattan_sajosis.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="strii_mjum_saa_m-musiikk_konsee_rt_sajoozzast.html"/>
