...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2020/10/08/juoigam-ja-mainastem-skovlimpeivi-mattaatteijeid-parnaitipsoid-ja-vaanhimaid/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'JUOIGÂM JÁ MAINÂSTEM - Škovlimpeivi máttáátteijeid, párnáitipšoid já vaanhimáid - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="joikaaminen_ja_tarinankerronta_-_koulutuspaiva_opettajille_lastenhoitajille_ja_vanhemmille.html"/>
        ...
        <parallel_text xml:lang="sme" location="juoigan_ja_mainnasteapmi.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="juoiggmos_da_mainnsimusttlummus_-_skooultospei_vv_u_ctee_lid_paarnaihaiddjid_da_puarrsid.html"/>
