...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/iyil2019/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'OA algâaalmugkielâi teemaihe - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="vuonna_2019_vietetaan_yk:n_alkuperaiskansojen_kielten_teemavuotta.html"/>
        ...
        <parallel_text xml:lang="sme" location="mailmmi_eamialbmotgielaid_jahki.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="ee_jj_2019_vio_ttjet_om:i_alggmeerai_kioli_tee_mmee_jj.html"/>
