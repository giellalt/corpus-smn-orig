...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2022/01/31/uasalist-sammilij-aalmugpiaivan-kost-peri/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Uásálist Sämmilij aalmugpiäiván kost peri - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="osallistu_saamelaisten_kansallispaivaan_paikasta_riippumatta.html"/>
        ...
        <parallel_text xml:lang="sme" location="searvva_sami_albmotbeaivai_ledjet_dal_gos_beare.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="vuassood_saa_mi_meersazpeivva_da_aa_n_ij_leakku_paai_kest_kidd.html"/>
