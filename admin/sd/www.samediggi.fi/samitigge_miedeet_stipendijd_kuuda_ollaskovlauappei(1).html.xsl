...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/12/02/samitigge-miedeet-stipendijd-kuuda-ollaskovlauappei/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sämitigge mieđeet stipendijd kuuđâ ollâškovlâuáppei - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaiskarajat_antaa_stipendin_kuudelle_korkeakouluopiskelijalle.html"/>
        ...
        <parallel_text xml:lang="sme" location="samediggi_juohka_stipeanddaid_guda_allaskuvlastudentii.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_mte_gg_oudd_stipee_nd_ku_tte_ollskooulmatt_toottja(0).html"/>
