...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2022/05/31/samitigge-valda-anon-spiekastahtile-samitige-toimanaavca-ja-pargei-pargotorvolasvuoda-visasmittem-tiet/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sämitigge váldá anon spiekâstâhtile Sämitige toimânaavcâ já pargei pargotorvolâšvuođâ visásmittem tiet - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaiskarajat_ottaa_kayttoon_poikkeustilan_saamelaiskarajien_toimintakyvyn_ja_henkiloston_tyoturvallisuuden_varmistamiseksi.html"/>
        ...
        <parallel_text xml:lang="sme" location="samediggi_valda_geavahussii_spiehkastatdili_samedikki_doaibmannavcca_ja_bargoveaga_bargodorvvolasvuoda_sihkkarastima_varas.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_mte_gg_valdd_aannmo_sse_pannsam_vue_jj_saa_mtee_gg_taimmjempastlvazvuod_da_tuajjlazkaa_dd_tuajjstaanvuod_ra_vvjem_vaaras.html"/>
