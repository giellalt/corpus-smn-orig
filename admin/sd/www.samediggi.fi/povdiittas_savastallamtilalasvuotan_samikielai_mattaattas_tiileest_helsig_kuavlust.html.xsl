...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2023/06/30/povdiittas-savastallamtilalasvuotan-samikielai-mattaattas-tiileest-helsig-kuavlust/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Povdiittâs savâstâllâmtilálâšvuotân sämikielâi máttááttâs tiileest Helsig kuávlust - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="kutsu_keskustelutilaisuuteen_saamen_kielten_opetuksen_tilanteesta_helsingin_seudulla.html"/>
        ...
        <parallel_text xml:lang="sme" location="bovdehus_sagastallandilalasvuhtii_samegielaid_oahpahusa_dilis_helssega_guovllus.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="kacc_sagstoollampo_dde_saa_mkioli_matt_toozz_vue_jjest_he_lssen_vuu_dest.html"/>
