...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/08/16/samitigge-nomattam-neelji-samasteaddji-saamsteei-samasteijee/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sämitigge nomâttâm neelji “Sámásteaddji - Säämsteei - Sámásteijee” - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaiskarajat_nimesi_nelja_kielilahettilasta_samasteaddji.html"/>
        ...
        <parallel_text xml:lang="sme" location="samediggi_nammadan_njealjje_samasteaddji.html"/>
