...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2023/05/12/samitigge-oca-kaidusmattaattas-koordinaattor-2/?lang=an'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaiskarajat_hakee_etaopetuksen_koordinaattoria.html"/>
        ...
        <parallel_text xml:lang="sme" location="samediggi_ohca_gaiddusoahpahusa_koordinahtora.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_mte_gg_aacc_ougglosmatt_toozz_koordinaattoor.html"/>
