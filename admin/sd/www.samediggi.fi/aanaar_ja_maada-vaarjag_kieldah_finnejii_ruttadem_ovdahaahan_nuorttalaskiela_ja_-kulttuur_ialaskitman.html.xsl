...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2022/12/15/aanaar-ja-maada-vaarjag-kieldah-finnejii-ruttadem-ovdahaahan-nuorttalaskiela-ja-kulttuur-ialaskitman/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Aanaar já Maadâ-Vaarjâg kieldah finnejii ruttâdem ovdâhaahân nuorttâlâškielâ já -kulttuur iäláskitmân - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="inarin_ja_sor-varangin_kunnat_saivat_rahoituksen_esihankkeelle_koltansaamen_kielen_ja_kulttuurin_elvyttamiseksi.html"/>
        ...
        <parallel_text xml:lang="sme" location="anara_ja_matta-varjjaga_gielddat_ozzo_ruhtadeami_nuortalasgiela_ja_-kultuvrra_ealaskahttima_ovdaprosektii.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="aanar_da_sor-varangi_kaa_dd_vuozhzhu_teaggtoozz_vuossha_ngkko_sse_nuorttsaa_m_kiol_da_kulttuur_jealltummsen.html"/>
