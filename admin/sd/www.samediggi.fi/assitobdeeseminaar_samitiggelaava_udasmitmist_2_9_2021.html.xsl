...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2021/08/24/assitobdeeseminaar-samitiggelaava-udasmitmist-2-9-2021/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Äššitobdeeseminaar sämitiggelaavâ uđâsmitmist 2.9.2021 - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="expert_workshop_to_assess_proposals_for_amending_the_sami_parliament_act_in_finland_on_2_september.html"/>
        <parallel_text xml:lang="fin" location="asiantuntijaseminaari_saamelaiskarajalain_uudistamisesta_2_9_2021.html"/>
        ...
        <parallel_text xml:lang="sme" location="assedovdiseminara_samediggelaga_odasmahttimis_2_9_2021.html"/>
