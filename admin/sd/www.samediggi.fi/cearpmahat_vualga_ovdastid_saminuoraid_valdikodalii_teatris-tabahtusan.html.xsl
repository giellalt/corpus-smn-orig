...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/04/11/cearpmahat-vualga-ovdastid-saminuoraid-valdikodalii-teatris-tabahtusan/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Čearpmahat vuálgá ovdâstiđ säminuorâid väldikodálii Teatris-tábáhtusân - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="cearpmahat_lahtee_edustamaan_saamelaisnuoria_valtakunnalliseen_teatris-tapahtumaan.html"/>
        ...
        <parallel_text xml:lang="sme" location="cearpmahat_vuolga_ovddastit_samenuoraid_riikkaviidosas_teatris-dahpahussii.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="cearpmahat_vualgg_ee_tkked_saa_mnuorid_va_lddkaaddlaz_teatris-soddmo_sse.html"/>
