...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2021/08/26/puadi-feerimassitobden-kulttuurij-skoovlan/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Puáđi feerimäššitobden Kulttuurij škoovlân! - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="tule_kokemusasiantuntijaksi_kulttuurien_kouluun_.html"/>
        ...
        <parallel_text xml:lang="sme" location="boade_vasahusassedovdin_kultuvrraid_skuvlii_.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="pua_d_a_sstobddisilttee_jen_kulttuuri_skoou_le_.html"/>
