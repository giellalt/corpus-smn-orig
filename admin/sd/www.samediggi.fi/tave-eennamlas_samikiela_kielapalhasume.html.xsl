...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/tave-eennamlas-samikiela-kielapalhasume/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Tave-eennâmlâš sämikielâ kielâpalhâšume - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="gollegiella_-_pohjoismainen_saamen_kielen_kielipalkinto.html"/>
        ...
        <parallel_text xml:lang="sme" location="davviriikkalas_samegiela_giellabalkkasupmi.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="ta_vvjannmallas_saa_mkiol_kiollcistt.html"/>
