...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2022/02/07/samitigge-almoot-uuccamnaal-meriaigasii-saminuorai-taaidatabahtus-proojeektpargee-tooima-3/?lang=an'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamelaiskarajat_ilmoittaa_haettavaksi_maaraaikaisen_saamelaisnuorten_taidetapahtuman_projektityontekijan_tehtavan(1).html"/>
        ...
        <parallel_text xml:lang="sme" location="samediggi_almmuha_ohcan_lahkai_mearreaigasas_samenuoraid_daiddadahpahusa_proseaktabargi_doaimma(1).html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="saa_mte_gg_i_lmmat_ooccamnalla_mie_rraiggsaz_saa_mnuori_cea_ppvuottpeei_v_proje_ktt-tuajjla_tuaj.html"/>
