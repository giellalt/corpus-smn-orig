...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/09/20/anaraskiela-vieres-kielan-oppakirjeraidu-valmastui/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Anarâškielâ vieres kielân oppâkirjeráiđu valmâštui - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="inarinsaamen_vieraan_kielen_oppikirjasarja_valmistui.html"/>
        ...
        <parallel_text xml:lang="sme" location="anarasgiela_vieris_giela_oahppagirjeraidu_garvvasnuvai.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="aanarsaa_m_vee_reskiol_mattke_rjjraidd_lij_vaalmas.html"/>
