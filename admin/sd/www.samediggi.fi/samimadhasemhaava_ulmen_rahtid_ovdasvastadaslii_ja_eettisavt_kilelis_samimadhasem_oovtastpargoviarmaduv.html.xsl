...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2021/10/26/samimadhasemhaava-ulmen-rahtid-ovdasvastadaslii-ja-eettisavt-kilelis-samimadhasem-oovtastpargoviarmaduv/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sämimađhâšemhaavâ ulmen rähtiđ ovdâsvástádâslii já eettisávt kilelis sämimađhâšem oovtâstpargoviärmáduv - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="sami_tourism_project_aims_at_building_a_responsible_and_ethically_sustainable_sami_tourism_collaboration_network.html"/>
        <parallel_text xml:lang="fin" location="saamelaismatkailuhanke_tahtaa_vastuullisen_ja_eettisesti_kestavan_saamelaismatkailun_yhteistyoverkoston_rakentamiseen.html"/>
        ...
        <parallel_text xml:lang="sme" location="sameturismaproseavtta_ulbmilin_rahkadit_vasttolas_ja_etihkalaccat_suvdilis_sameturismma_oktasasbargofierpmadaga.html"/>
