...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2023/05/11/kyehti-udda-nuorttalaskiela-pargokirje-laa-almostum/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Kyehti uđđâ nuorttâlâškielâ pargokirje láá almostum - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="kaksi_uutta_koltansaamen_kielen_tyokirjaa_on_julkaistu_.html"/>
        ...
        <parallel_text xml:lang="sme" location="guokte_odda_nuortalasgielat_bargogirjji_lea_almmuhuvvon.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="kuo_htt_odd_nuorttsaa_mkiol_tuejjkee_rj_lie_olmstottum.html"/>
