...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2022/12/16/suoma-samitigge-ja-tianu-kyelitualukuavlu-kiasadateh-tianu-pivdonjuolgadusradadalmijn-taaza-virgeomahai-covga-vatamas-keezild/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Suomâ Sämitigge já Tiänu kyelituálukuávlu kiäsádâteh Tiänu pivdonjuolgâdusráđádâlmijn Taažâ virgeomâhái čovgâ vátámâš keežild - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="suomen_saamelaiskarajat_ja_tenon_kalatalousalue_vetaytyvat_tenon_kalastussaantoneuvotteluista_norjan_viranomaisten_tiukan_vaatimuksen_seurauksena.html"/>
        ...
        <parallel_text xml:lang="sme" location="suoma_samediggi_ja_deanu_guolledoalloguovlu_geassadit_deanu_bivdonjuolggadusraddadallamiin_norgga_eisevalddiid_cavga_gaibadusa_geazil.html"/>
