...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2021/10/25/pyeri-puattim-nuorttasamikielalii-anatomiasanilisto-almostittemtilalasvuotan/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Pyeri puáttim nuorttâsämikielâlii anatomiasänilisto almostittemtilálâšvuotân! - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="tervetuloa_koltansaamen_anatomiasanaston_julkaisutilaisuuteen_.html"/>
        ...
        <parallel_text xml:lang="sme" location="bures_boahtin_nuortalasgiela_anatomiijasatnelisttu_almmuhandilalasvuhtii_.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location="tiorv_pue_ttmest_nuorttsaa_m_anatomiasannoozz_olmsta_ttempo_dde_.html"/>
