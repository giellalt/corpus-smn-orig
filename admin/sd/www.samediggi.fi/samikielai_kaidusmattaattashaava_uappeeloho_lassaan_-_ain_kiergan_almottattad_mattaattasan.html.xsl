...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.samediggi.fi/2019/03/18/samikielai-kaidusmattaattashaava-uappeeloho-lassaan-ain-kiergan-almottattad-mattaattasan/?lang=an'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sämikielâi káidusmáttááttâshaavâ uáppeeloho lassaan – ain kiergân almottâttâđ máttááttâsân - Samediggi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="fin" location="saamen_kielten_etaopetushankkeen_oppilasmaara_kasvaa_-_viela_ehtii_ilmoittautua_opetukseen.html"/>
        ...
        <parallel_text xml:lang="sms" location="saa_mkioli_ougglosmatt_tosha_ngkkoozz_matt_toottimie_rr_lassan_-_vol_kiorggan_i_lmmtoottad_matt_to_sse.html"/>
