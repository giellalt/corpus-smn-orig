...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.giella.org/wp-content/uploads/2014/02/pevdikirje-%C4%8Du%C3%A1kkim-15.-16.11.2013.pdf'"/>
    ...
    <xsl:variable name="top_margin" select="'all=13'"/>
    <xsl:variable name="bottom_margin" select="'all=13'"/>
