...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'Liigaliiseens_puoh_Veikkausliigajuávhoid_pajan_2023.docx'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Liigaliiseens puoh Veikkausliigajuávhoid pajan 2023'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Fabrizio'"/>
    <xsl:variable name="author1_ln" select="'Brecciaroli'"/>
    <!-- m, f or unknown -->
