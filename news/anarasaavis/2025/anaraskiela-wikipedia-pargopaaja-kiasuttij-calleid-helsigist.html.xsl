...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.anarasaavis.fi/2025/03/18/anaraskiela-wikipedia-pargopaaja-kiasuttij-calleid-helsigist/'"/>
    ...
    -->
    <xsl:variable name="author1_fn" select="'Marja-Liis'"/>
