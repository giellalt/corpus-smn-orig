...
<xsl:import href="file:///Users/ttr000/.python-eggs/CorpusTools-0.7.1-py2.7.egg-tmp/corpustools/xslt/common.xsl"/>
...
<xsl:variable name="filename" select="'RITVA_Suomen_saamelaisten_yhteiskunnallinen_anarâsjkielân.rtf'"/>
